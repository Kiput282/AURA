...
class AuraBackupRestoreRehearsalPlanner:
    VERSION = "1.1.0"
    ANCHOR_VERSION = "1.0.9-genesis"
    CURRENT_SPRINT = 250
    NEXT_SPRINT = 251
    NEXT_VERSION = "1.1.1"
    BOUNDARY = "backup_restore_rehearsal"
    NEXT_BOUNDARY = "aura_launcher_service_controls"
    OWNER = "AuraBackupRestoreRehearsalPlanner"
    CONTRACT_MODE = "read_only_backup_restore_rehearsal"
    REVIEW_MODE = "source_contract_evidence_snapshot"
    EXPECTED_ASSERTION_COUNT = 96
    SPRINT_249_ANCHOR_ASSERTIONS = 96
    ...
    DIMENSION_ORDER = (
        ...
        "manifest_and_digest_integrity",
        "restore_plan_reversibility",
        "permission_and_approval_boundary",
        "audit_and_provenance_linkage",
        "safe_idle_failure_verification",
        "contract_deduplication",
        "block_release_acceptance",
    )
    DIMENSION_SPECS = {
        "backup_scope_inventory": {
            "sources": (
                "aura/controlled_file_write_approval_draft/"
                "aura_controlled_file_write_approval_draft_foundation_manager.py",
                "aura/session_memory_persistence_checks/"
                "aura_session_memory_persistence_checks_planner.py",
        ...
        "manifest_and_digest_integrity": {
            "sources": (
                ...
                "aura/resource_baseline_metrics/"
                "aura_resource_baseline_metrics_planner.py",
        ...
        "permission_and_approval_boundary": {
            "sources": (
                ...
                "aura/permission_expiry_recovery_review/"
                "aura_permission_expiry_recovery_review_planner.py",
            ),
            "groups": (
                (
                    "permission_scope",
                ...
                (
                    ...
                    (
                        "permission_store_mutation_enabled",
                        "runtime_disabled",
                        "no_permission",
                    ),
                ),
        ...
        "audit_and_provenance_linkage": {
            "sources": (
                ...
                "aura_runtime_permission_audit_writer_boundary_review_foundation_manager.py",
                "aura/runtime_audit_event_packet_preview/"
                "aura_runtime_audit_event_packet_preview_foundation_manager.py",
                "aura/permission_audit_recovery_visibility_runtime/"
                "aura_permission_audit_recovery_visibility_runtime_manager.py",
            ),
            "groups": (
                (
                    "audit_reference",
        ...
        "contract_deduplication": {
            "sources": (
                ...
                "aura_runtime_permission_flow_consolidation_foundation_manager.py",
                "aura/context/context_manager.py",
                "aura/output_formatter/"
                "shared_output_formatter_manager.py",
            ),
            "groups": (
                (
        ...
        "block_release_acceptance": {
            "sources": (
                ...
                "genesis_stabilization_runtime_hardening_planner.py",
                "aura/final_genesis_acceptance_criteria_foundation/"
                "aura_final_genesis_acceptance_criteria_foundation_manager.py",
                "aura/permission_expiry_recovery_review/"
                "aura_permission_expiry_recovery_review_planner.py",
            ),
            "groups": (
                (
                    "hardening_block",
                    (
                        "genesis_stabilization_runtime_hardening",
                        "hardening",
                        "stabilization",
                    ),
                ),
    ...
    def _runtime_boundary() -> dict[str, bool]:
        return {
            ...
            "file_replacement_enabled": False,
            "file_deletion_enabled": False,
            "archive_creation_enabled": False,
    ...
    def _build_review_packet(self) -> dict[str, Any]:
        ...
        return {
            ...
            "sprint_249_anchor_assertions": (
                self.SPRINT_249_ANCHOR_ASSERTIONS
            ),
            ...
            "source_contract": {
                ...
                "backup_store_content_read": False,
                "restore_source_content_read": False,
                "backup_runtime_imported": False,
                "restore_runtime_executed": False,
    ...
    def context(self) -> dict[str, Any]:
        ...
        return {
            ...
            "scope_boundary": {
                "read_only_rehearsal_only": True,
                "backup_creation_deferred": True,
                "restore_execution_deferred": True,
                "file_replacement_deferred": True,
                "permission_audit_mutation_deferred": True,
                "safe_idle_failure_verified": (
                    dimension_map[
                        "safe_idle_failure_verification"
                    ]["state"]
                    == "secure"
                ),
                "contract_deduplication_reviewed": (
                    dimension_map[
                        "contract_deduplication"
                    ]["state"]
                    == "secure"
                ),
                "aura_launcher_service_controls_next": True,
            },
        }
    ...
    def check(self) -> dict[str, Any]:
        ...
        add(
            "sprint_249_anchor_assertion_count",
            packet["sprint_249_anchor_assertions"]
            == self.SPRINT_249_ANCHOR_ASSERTIONS,
        )
        add(
            "topology_candidate_count",
            topology["candidate_count"] == 10,
        )
        add(
            "topology_records_count",
            len(topology["records"]) == 10,
        )
        add(
        ...
        add(
            ...
            source["python_source_read_only"] is True,
        )
        add(
            "ast_inspection_only",
        ...
        add(
            "canonical_data_content_not_read",
            source["canonical_data_content_read"] is False,
        )
        add(
            "backup_store_content_not_read",
            source["backup_store_content_read"] is False,
        )
        add(
            "restore_source_content_not_read",
            source["restore_source_content_read"] is False,
        )
        add(
            "backup_runtime_not_imported",
            source["backup_runtime_imported"] is False,
        )
        add(
            "restore_runtime_not_executed",
            source["restore_runtime_executed"] is False,
        )
        add(
            "subprocess_not_used",
        ...
        add(
            "scope_read_only_rehearsal",
            scope["read_only_rehearsal_only"] is True,
        )
        add(
            "backup_creation_deferred",
            scope["backup_creation_deferred"] is True,
        )
        add(
            "restore_execution_deferred",
            scope["restore_execution_deferred"] is True,
        )
        add(
            "file_replacement_deferred",
            scope["file_replacement_deferred"] is True,
        )
        add(
            "permission_audit_mutation_deferred",
            scope[
                "permission_audit_mutation_deferred"
            ]
            is True,
        ...
        add(
            "safe_idle_failure_verified",
            scope["safe_idle_failure_verified"] is True,
        )
        add(
            "contract_deduplication_reviewed",
            scope[
        ...
        add(
            "launcher_service_controls_next",
            scope[
                "aura_launcher_service_controls_next"
            ]
            is True,
        )
