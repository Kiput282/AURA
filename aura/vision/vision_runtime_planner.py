...
class VisionRuntimePlanner:
    ...
    def status(self) -> dict[str, Any]:
        ...
        return {
            ...
            "vision_runtime_block_start": integration_review["vision_runtime_block_start"],
            "vision_runtime_block_end": integration_review["vision_runtime_block_end"],
            "vision_runtime_current_sprint": integration_review["vision_runtime_current_sprint"],
            "vision_runtime_next_sprint": integration_review["vision_runtime_next_sprint"],
            "vision_runtime_next_boundary": integration_review["vision_runtime_next_boundary"],
            "vision_runtime_activation_allowed": integration_review["runtime_activation_allowed"],
            "vision_release_gate_open": integration_review["release_gate_open"],
            ...
            "vision_safety_blocker_count": integration_review["safety_blocker_count"],
            "vision_all_safety_blockers_inactive": integration_review["all_safety_blockers_inactive"],
            ...
            "note": "Vision Runtime Integration Review contract is ready for Sprint 209; it reviews Sprint 201-208 vision contracts and integration gates while keeping runtime activation, screenshot capture, image file read, OCR, model requests, chat handoff, panel rendering, routes/API endpoints, data fetch, permission mutation, audit writes, memory writes, visual actions, cloud fallback, and external upload disabled.",
        }
