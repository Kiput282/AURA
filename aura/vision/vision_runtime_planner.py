...
class VisionRuntimePlanner:
    ...
    def status(self) -> dict[str, Any]:
        ...
        return {
            ...
            "vision_runtime_block_start": workspace_visual["vision_runtime_block_start"],
            "vision_runtime_block_end": workspace_visual["vision_runtime_block_end"],
            "vision_runtime_current_sprint": workspace_visual["vision_runtime_current_sprint"],
            ...
            "note": "Workspace visual understanding contract is ready for Sprint 206; it defines provided and redacted workspace visual context schemas while keeping workspace understanding runtime, summary creation, screenshot capture, image file read, OCR, model request, inference, context/chat handoff, memory writes, visual actions, cloud fallback, and external upload disabled.",
        }
    ...
    def check(self) -> dict[str, Any]:
        ...
        assertions = {
            ...
            "workspace_visual_understanding_status_ready": workspace_visual["workspace_visual_understanding_status"] == "workspace_visual_understanding_contract_ready",
            "vision_runtime_block_start_201": workspace_visual["vision_runtime_block_start"] == 201,
            "vision_runtime_block_end_210": workspace_visual["vision_runtime_block_end"] == 210,
            "vision_runtime_current_sprint_206": workspace_visual["vision_runtime_current_sprint"] == 206,
            "vision_runtime_next_sprint_207": workspace_visual["vision_runtime_next_sprint"] == 207,
            "vision_runtime_next_boundary_vision_to_chat_context_handoff": workspace_visual["vision_runtime_next_boundary"] == "vision_to_chat_context_handoff",
            "previous_activation_contract_ready": workspace_visual["previous_activation_contract_ready"] is True,
            "previous_screenshot_contract_ready": workspace_visual["previous_explicit_screenshot_capture_contract_ready"] is True,
            "previous_screen_context_contract_ready": workspace_visual["previous_screen_context_adapter_contract_ready"] is True,
            "previous_local_model_contract_ready": workspace_visual["previous_local_vision_model_adapter_contract_ready"] is True,
            "previous_permission_redaction_contract_ready": workspace_visual["previous_vision_permission_redaction_contract_ready"] is True,
            "previous_permission_redaction_runtime_not_ready": workspace_visual["previous_vision_permission_redaction_runtime_ready"] is False,
            "runtime_not_ready": workspace_visual["runtime_ready"] is False,
            "runtime_activation_not_allowed": workspace_visual["runtime_activation_allowed"] is False,
            "release_gate_closed": workspace_visual["release_gate_open"] is False,
            "contract_only": workspace_visual["workspace_visual_understanding_contract_only"] is True,
            "provided_redacted_visual_context_required": workspace_visual["provided_redacted_visual_context_required"] is True,
            "provided_screen_metadata_required": workspace_visual["provided_screen_metadata_required"] is True,
            "provided_workspace_metadata_required": workspace_visual["provided_workspace_metadata_required"] is True,
            "provided_user_question_required": workspace_visual["provided_user_question_required"] is True,
            "provided_permission_packet_required": workspace_visual["provided_permission_packet_required"] is True,
            "redaction_proof_required": workspace_visual["redaction_proof_required"] is True,
            "source_metadata_required": workspace_visual["source_metadata_required"] is True,
            "uncertainty_required": workspace_visual["uncertainty_required"] is True,
            "workspace_visual_summary_schema_ready": workspace_visual["workspace_visual_summary_schema_ready"] is True,
            "workspace_layout_schema_ready": workspace_visual["workspace_layout_schema_ready"] is True,
            "active_window_schema_ready": workspace_visual["active_window_schema_ready"] is True,
            "visible_region_schema_ready": workspace_visual["visible_region_schema_ready"] is True,
            "visual_element_schema_ready": workspace_visual["visual_element_schema_ready"] is True,
            "attention_target_schema_ready": workspace_visual["attention_target_schema_ready"] is True,
            "workspace_risk_schema_ready": workspace_visual["workspace_risk_schema_ready"] is True,
            "limitation_schema_ready": workspace_visual["limitation_schema_ready"] is True,
            "workspace_overview_contract_ready": workspace_visual["workspace_overview_contract_ready"] is True,
            "window_layout_contract_ready": workspace_visual["window_layout_contract_ready"] is True,
            "visible_region_contract_ready": workspace_visual["visible_region_contract_ready"] is True,
            "ui_element_hint_contract_ready": workspace_visual["ui_element_hint_contract_ready"] is True,
            "task_context_contract_ready": workspace_visual["task_context_contract_ready"] is True,
            "risk_summary_contract_ready": workspace_visual["risk_summary_contract_ready"] is True,
            "uncertainty_summary_contract_ready": workspace_visual["uncertainty_summary_contract_ready"] is True,
            "permission_required_before_workspace_understanding": workspace_visual["permission_required_before_workspace_understanding"] is True,
            "permission_required_before_context_handoff": workspace_visual["permission_required_before_context_handoff"] is True,
            "permission_required_before_chat_handoff": workspace_visual["permission_required_before_chat_handoff"] is True,
            "redaction_required_before_workspace_understanding": workspace_visual["redaction_required_before_workspace_understanding"] is True,
            "redaction_required_before_workspace_summary": workspace_visual["redaction_required_before_workspace_summary"] is True,
            "redaction_required_before_context_handoff": workspace_visual["redaction_required_before_context_handoff"] is True,
            "redaction_required_before_chat_handoff": workspace_visual["redaction_required_before_chat_handoff"] is True,
            "no_raw_screenshot_to_workspace": workspace_visual["no_raw_screenshot_to_workspace"] is True,
            "no_raw_screenshot_to_chat": workspace_visual["no_raw_screenshot_to_chat"] is True,
            "no_unredacted_context_to_workspace": workspace_visual["no_unredacted_context_to_workspace"] is True,
            "no_unredacted_context_to_chat": workspace_visual["no_unredacted_context_to_chat"] is True,
            "no_ocr_claims_without_ocr": workspace_visual["no_ocr_claims_without_ocr"] is True,
            "no_model_claims_without_model": workspace_visual["no_model_claims_without_model"] is True,
            "no_identity_claims": workspace_visual["no_identity_claims"] is True,
            "no_biometric_identification": workspace_visual["no_biometric_identification"] is True,
            "no_face_recognition": workspace_visual["no_face_recognition"] is True,
            "no_emotion_inference_from_face": workspace_visual["no_emotion_inference_from_face"] is True,
            "no_action_recommendation_without_permission": workspace_visual["no_action_recommendation_without_permission"] is True,
            "no_visual_context_to_action_bypass": workspace_visual["visual_context_to_action_bypass_enabled"] is False,
            "image_file_read_not_allowed": workspace_visual["image_file_read_allowed"] is False,
            "screenshot_capture_not_required_now": workspace_visual["screenshot_capture_required_now"] is False,
            "screenshot_file_read_not_required_now": workspace_visual["screenshot_file_read_required_now"] is False,
            "ocr_not_required_now": workspace_visual["ocr_required_now"] is False,
            "cloud_vision_fallback_not_allowed": workspace_visual["cloud_vision_fallback_allowed"] is False,
            "external_upload_not_allowed": workspace_visual["external_upload_allowed"] is False,
            "model_download_not_required_now": workspace_visual["model_download_required_now"] is False,
            "dependency_install_not_performed": workspace_visual["dependency_install_performed"] is False,
            "workspace_visual_understanding_runtime_inactive": workspace_visual["workspace_visual_understanding_runtime_active"] is False,
            "workspace_visual_summary_not_created": workspace_visual["workspace_visual_summary_created"] is False,
            "workspace_layout_not_created": workspace_visual["workspace_layout_created"] is False,
            "visual_element_list_not_created": workspace_visual["visual_element_list_created"] is False,
            "attention_target_not_created": workspace_visual["attention_target_created"] is False,
            "workspace_risk_assessment_not_created": workspace_visual["workspace_risk_assessment_created"] is False,
            "workspace_to_chat_handoff_inactive": workspace_visual["workspace_to_chat_handoff_active"] is False,
            "permission_prompt_runtime_inactive": workspace_visual["permission_prompt_runtime_active"] is False,
            "permission_grant_mutation_inactive": workspace_visual["permission_grant_mutation_active"] is False,
            "redaction_runtime_inactive": workspace_visual["redaction_runtime_active"] is False,
            "redaction_preview_not_created": workspace_visual["redaction_preview_created"] is False,
            "redacted_context_not_created": workspace_visual["redacted_context_created"] is False,
            "redaction_audit_write_inactive": workspace_visual["redaction_audit_write_active"] is False,
            "screen_capture_runtime_not_ready": workspace_visual["screen_capture_runtime_ready"] is False,
            "screenshot_capture_not_performed": workspace_visual["screenshot_capture_performed"] is False,
            "screenshot_output_not_created": workspace_visual["screenshot_output_file_created"] is False,
            "screenshot_file_read_inactive": workspace_visual["screenshot_file_read_active"] is False,
            "screen_context_packet_not_created": workspace_visual["screen_context_packet_created"] is False,
            "screen_context_handoff_inactive": workspace_visual["screen_context_handoff_active"] is False,
            "local_model_adapter_inactive": workspace_visual["local_vision_model_adapter_active"] is False,
            "local_model_provider_probe_inactive": workspace_visual["local_model_provider_probe_active"] is False,
            "local_model_request_inactive": workspace_visual["local_model_request_active"] is False,
            "local_model_inference_inactive": workspace_visual["local_model_inference_active"] is False,
            "model_to_chat_handoff_inactive": workspace_visual["model_to_chat_handoff_active"] is False,
            "vision_model_runtime_inactive": workspace_visual["vision_model_runtime_active"] is False,
            "ocr_runtime_inactive": workspace_visual["ocr_runtime_active"] is False,
            "image_analysis_runtime_inactive": workspace_visual["image_analysis_runtime_active"] is False,
            "object_detection_runtime_inactive": workspace_visual["object_detection_runtime_active"] is False,
            "visual_action_execution_inactive": workspace_visual["visual_action_execution_active"] is False,
            "visual_tool_execution_inactive": workspace_visual["visual_tool_execution_active"] is False,
            "command_execution_inactive": workspace_visual["command_execution_active"] is False,
            "file_mutation_inactive": workspace_visual["file_mutation_active"] is False,
            "desktop_action_inactive": workspace_visual["desktop_action_active"] is False,
            "network_action_inactive": workspace_visual["network_action_active"] is False,
            "git_action_inactive": workspace_visual["git_action_active"] is False,
            "memory_write_inactive": workspace_visual["memory_write_active"] is False,
            "cloud_vision_fallback_disabled": workspace_visual["cloud_vision_fallback_enabled"] is False,
            "external_upload_disabled": workspace_visual["external_upload_enabled"] is False,
            "no_tool_use_from_visual_context": workspace_visual["no_tool_use_from_visual_context"] is True,
            "no_autonomous_action": workspace_visual["no_autonomous_action"] is True,
            "safety_blocker_count_33": workspace_visual["safety_blocker_count"] == 33,
            "all_safety_blockers_inactive": workspace_visual["all_safety_blockers_inactive"] is True,
        }

        for blocker in workspace_visual["safety_blockers"]:
            assertions[f"safety_blocker_{blocker}_inactive"] = workspace_visual[blocker] is False
        ...
        return {
            ...
            "vision_permission_redaction_contract": permission_redaction,
            "workspace_visual_understanding_contract": workspace_visual,
            "note": "Runtime is not enabled yet. This check prepared the Sprint 206 workspace visual understanding contract without creating workspace summaries, reading screenshots or image files, running OCR, sending model requests, running inference, handing off context/chat, executing tools/commands, writing memory, controlling desktop, using network/git, cloud vision, external upload, or visual actions.",
        }
