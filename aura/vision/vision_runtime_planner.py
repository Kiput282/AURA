...
class VisionRuntimePlanner:
    ...
    def status(self) -> dict[str, Any]:
        ...
        return {
            ...
            "vision_runtime_block_start": permission_redaction["vision_runtime_block_start"],
            "vision_runtime_block_end": permission_redaction["vision_runtime_block_end"],
            "vision_runtime_current_sprint": permission_redaction["vision_runtime_current_sprint"],
            ...
            "screenshot_capture_active": permission_redaction["screenshot_capture_active"],
            "screenshot_capture_performed": permission_redaction["screenshot_capture_performed"],
            "screenshot_output_file_created": permission_redaction["screenshot_output_file_created"],
            ...
            "screen_context_packet_created": permission_redaction["screen_context_packet_created"],
            "screen_context_handoff_active": permission_redaction["screen_context_handoff_active"],
            ...
            "local_vision_model_adapter_active": permission_redaction["local_vision_model_adapter_active"],
            "local_model_provider_probe_active": permission_redaction["local_model_provider_probe_active"],
            "local_model_request_active": permission_redaction["local_model_request_active"],
            "local_model_inference_active": permission_redaction["local_model_inference_active"],
            "local_model_response_created": local_model["local_model_response_created"],
            "model_to_chat_handoff_active": permission_redaction["model_to_chat_handoff_active"],
            ...
            "vision_model_runtime_active": permission_redaction["vision_model_runtime_active"],
            "ocr_runtime_active": permission_redaction["ocr_runtime_active"],
            "cloud_vision_fallback_enabled": permission_redaction["cloud_vision_fallback_enabled"],
            "external_upload_enabled": permission_redaction["external_upload_enabled"],
            ...
            "note": "Vision permission and redaction contract is ready for Sprint 205; it defines explicit permission, confirmation, scope, audit, and redaction gates while keeping permission mutation, redaction runtime, screenshot capture, image file read, OCR, model request, inference, context/chat handoff, visual actions, command/tool execution, memory writes, cloud fallback, and external upload disabled.",
        }
    ...
    def check(self) -> dict[str, Any]:
        ...
        assertions = {
            ...
            "vision_permission_redaction_status_ready": permission_redaction["vision_permission_redaction_status"] == "vision_permission_and_redaction_contract_ready",
            "vision_runtime_block_start_201": permission_redaction["vision_runtime_block_start"] == 201,
            "vision_runtime_block_end_210": permission_redaction["vision_runtime_block_end"] == 210,
            "vision_runtime_current_sprint_205": permission_redaction["vision_runtime_current_sprint"] == 205,
            "vision_runtime_next_sprint_206": permission_redaction["vision_runtime_next_sprint"] == 206,
            "vision_runtime_next_boundary_workspace_visual_understanding": permission_redaction["vision_runtime_next_boundary"] == "workspace_visual_understanding",
            "previous_activation_contract_ready": permission_redaction["previous_activation_contract_ready"] is True,
            "previous_screenshot_contract_ready": permission_redaction["previous_explicit_screenshot_capture_contract_ready"] is True,
            "previous_screen_context_contract_ready": permission_redaction["previous_screen_context_adapter_contract_ready"] is True,
            "previous_local_model_contract_ready": permission_redaction["previous_local_vision_model_adapter_contract_ready"] is True,
            "previous_local_model_runtime_not_ready": permission_redaction["previous_local_vision_model_adapter_runtime_ready"] is False,
            "previous_model_request_inactive": permission_redaction["previous_local_model_request_active"] is False,
            "previous_model_inference_inactive": permission_redaction["previous_local_model_inference_active"] is False,
            "previous_model_to_chat_handoff_inactive": permission_redaction["previous_model_to_chat_handoff_active"] is False,
            "runtime_not_ready": permission_redaction["runtime_ready"] is False,
            "runtime_activation_not_allowed": permission_redaction["runtime_activation_allowed"] is False,
            "release_gate_closed": permission_redaction["release_gate_open"] is False,
            "contract_only": permission_redaction["vision_permission_redaction_contract_only"] is True,
            "explicit_visual_permission_required": permission_redaction["explicit_visual_permission_required"] is True,
            "explicit_visual_confirmation_required": permission_redaction["explicit_visual_confirmation_required"] is True,
            "foreground_only_required": permission_redaction["foreground_only_required"] is True,
            "single_capture_permission_scope": permission_redaction["single_capture_permission_scope"] is True,
            "per_request_permission_required": permission_redaction["per_request_permission_required"] is True,
            "permission_packet_schema_ready": permission_redaction["permission_packet_schema_ready"] is True,
            "permission_scope_schema_ready": permission_redaction["permission_scope_schema_ready"] is True,
            "permission_decision_schema_ready": permission_redaction["permission_decision_schema_ready"] is True,
            "permission_expiry_schema_ready": permission_redaction["permission_expiry_schema_ready"] is True,
            "audit_event_schema_ready": permission_redaction["audit_event_schema_ready"] is True,
            "redaction_policy_schema_ready": permission_redaction["redaction_policy_schema_ready"] is True,
            "redaction_preview_schema_ready": permission_redaction["redaction_preview_schema_ready"] is True,
            "redaction_scope_schema_ready": permission_redaction["redaction_scope_schema_ready"] is True,
            "sensitive_region_redaction_required": permission_redaction["sensitive_region_redaction_required"] is True,
            "window_title_redaction_required": permission_redaction["window_title_redaction_required"] is True,
            "url_redaction_required": permission_redaction["url_redaction_required"] is True,
            "clipboard_exclusion_required": permission_redaction["clipboard_exclusion_required"] is True,
            "secret_token_redaction_required": permission_redaction["secret_token_redaction_required"] is True,
            "personal_identifier_redaction_required": permission_redaction["personal_identifier_redaction_required"] is True,
            "visible_text_redaction_required": permission_redaction["visible_text_redaction_required"] is True,
            "permission_required_before_visual_input": permission_redaction["permission_required_before_visual_input"] is True,
            "permission_required_before_screenshot": permission_redaction["permission_required_before_screenshot"] is True,
            "permission_required_before_screen_context": permission_redaction["permission_required_before_screen_context"] is True,
            "permission_required_before_model_adapter": permission_redaction["permission_required_before_model_adapter"] is True,
            "permission_required_before_model_request": permission_redaction["permission_required_before_model_request"] is True,
            "permission_required_before_chat_handoff": permission_redaction["permission_required_before_chat_handoff"] is True,
            "permission_required_before_visual_action": permission_redaction["permission_required_before_visual_action"] is True,
            "redaction_required_before_context_adapter": permission_redaction["redaction_required_before_context_adapter"] is True,
            "redaction_required_before_context_packet": permission_redaction["redaction_required_before_context_packet"] is True,
            "redaction_required_before_model_request": permission_redaction["redaction_required_before_model_request"] is True,
            "redaction_required_before_model_response": permission_redaction["redaction_required_before_model_response"] is True,
            "redaction_required_before_chat_handoff": permission_redaction["redaction_required_before_chat_handoff"] is True,
            "redaction_required_before_memory_write": permission_redaction["redaction_required_before_memory_write"] is True,
            "no_raw_screenshot_to_model": permission_redaction["no_raw_screenshot_to_model"] is True,
            "no_raw_screenshot_to_chat": permission_redaction["no_raw_screenshot_to_chat"] is True,
            "no_unredacted_context_to_model": permission_redaction["no_unredacted_context_to_model"] is True,
            "no_unredacted_context_to_chat": permission_redaction["no_unredacted_context_to_chat"] is True,
            "no_clipboard_capture": permission_redaction["no_clipboard_capture"] is True,
            "no_sensitive_window_title_exposure": permission_redaction["no_sensitive_window_title_exposure"] is True,
            "no_url_exposure": permission_redaction["no_url_exposure"] is True,
            "no_identity_claims": permission_redaction["no_identity_claims"] is True,
            "no_biometric_identification": permission_redaction["no_biometric_identification"] is True,
            "no_face_recognition": permission_redaction["no_face_recognition"] is True,
            "no_emotion_inference_from_face": permission_redaction["no_emotion_inference_from_face"] is True,
            "no_visual_context_to_action_bypass": permission_redaction["visual_context_to_action_bypass_enabled"] is False,
            "image_file_read_not_allowed": permission_redaction["image_file_read_allowed"] is False,
            "screenshot_capture_not_required_now": permission_redaction["screenshot_capture_required_now"] is False,
            "screenshot_file_read_not_required_now": permission_redaction["screenshot_file_read_required_now"] is False,
            "ocr_not_required_now": permission_redaction["ocr_required_now"] is False,
            "cloud_vision_fallback_not_allowed": permission_redaction["cloud_vision_fallback_allowed"] is False,
            "external_upload_not_allowed": permission_redaction["external_upload_allowed"] is False,
            "model_download_not_required_now": permission_redaction["model_download_required_now"] is False,
            "dependency_install_not_performed": permission_redaction["dependency_install_performed"] is False,
            "permission_prompt_runtime_inactive": permission_redaction["permission_prompt_runtime_active"] is False,
            "permission_grant_mutation_inactive": permission_redaction["permission_grant_mutation_active"] is False,
            "redaction_runtime_inactive": permission_redaction["redaction_runtime_active"] is False,
            "redaction_preview_not_created": permission_redaction["redaction_preview_created"] is False,
            "redacted_context_not_created": permission_redaction["redacted_context_created"] is False,
            "redaction_audit_write_inactive": permission_redaction["redaction_audit_write_active"] is False,
            "screen_capture_runtime_not_ready": permission_redaction["screen_capture_runtime_ready"] is False,
            "screenshot_capture_not_performed": permission_redaction["screenshot_capture_performed"] is False,
            "screenshot_output_not_created": permission_redaction["screenshot_output_file_created"] is False,
            "screenshot_file_read_inactive": permission_redaction["screenshot_file_read_active"] is False,
            "screen_context_packet_not_created": permission_redaction["screen_context_packet_created"] is False,
            "screen_context_handoff_inactive": permission_redaction["screen_context_handoff_active"] is False,
            "local_model_adapter_inactive": permission_redaction["local_vision_model_adapter_active"] is False,
            "local_model_provider_probe_inactive": permission_redaction["local_model_provider_probe_active"] is False,
            "local_model_request_inactive": permission_redaction["local_model_request_active"] is False,
            "local_model_inference_inactive": permission_redaction["local_model_inference_active"] is False,
            "model_to_chat_handoff_inactive": permission_redaction["model_to_chat_handoff_active"] is False,
            "vision_model_runtime_inactive": permission_redaction["vision_model_runtime_active"] is False,
            "ocr_runtime_inactive": permission_redaction["ocr_runtime_active"] is False,
            "image_analysis_runtime_inactive": permission_redaction["image_analysis_runtime_active"] is False,
            "object_detection_runtime_inactive": permission_redaction["object_detection_runtime_active"] is False,
            "visual_action_execution_inactive": permission_redaction["visual_action_execution_active"] is False,
            "visual_tool_execution_inactive": permission_redaction["visual_tool_execution_active"] is False,
            "command_execution_inactive": permission_redaction["command_execution_active"] is False,
            "file_mutation_inactive": permission_redaction["file_mutation_active"] is False,
            "desktop_action_inactive": permission_redaction["desktop_action_active"] is False,
            "network_action_inactive": permission_redaction["network_action_active"] is False,
            "git_action_inactive": permission_redaction["git_action_active"] is False,
            "memory_write_inactive": permission_redaction["memory_write_active"] is False,
            "cloud_vision_fallback_disabled": permission_redaction["cloud_vision_fallback_enabled"] is False,
            "external_upload_disabled": permission_redaction["external_upload_enabled"] is False,
            "no_tool_use_from_visual_context": permission_redaction["no_tool_use_from_visual_context"] is True,
            "no_autonomous_action": permission_redaction["no_autonomous_action"] is True,
            "safety_blocker_count_33": permission_redaction["safety_blocker_count"] == 33,
            "all_safety_blockers_inactive": permission_redaction["all_safety_blockers_inactive"] is True,
        }

        for blocker in permission_redaction["safety_blockers"]:
            assertions[f"safety_blocker_{blocker}_inactive"] = permission_redaction[blocker] is False
        ...
        return {
            ...
            "local_vision_model_adapter_contract": local_model,
            "vision_permission_redaction_contract": permission_redaction,
            "note": "Runtime is not enabled yet. This check prepared the Sprint 205 vision permission and redaction contract without mutating permissions, running redaction, creating redacted context, capturing screenshots, reading image files, running OCR, sending model requests, running inference, handing off context/chat, executing tools/commands, writing memory, controlling desktop, using network/git, cloud vision, external upload, or visual actions.",
        }
