...
class VisionRuntimePlanner:
    ...
    def status(self) -> dict[str, Any]:
        ...
        return {
            ...
            "vision_runtime_block_start": screen_context["vision_runtime_block_start"],
            "vision_runtime_block_end": screen_context["vision_runtime_block_end"],
            "vision_runtime_current_sprint": screen_context["vision_runtime_current_sprint"],
            ...
            "screenshot_capture_active": screen_context["screenshot_capture_active"],
            "screenshot_capture_performed": screen_context["screenshot_capture_performed"],
            "screenshot_output_file_created": screen_context["screenshot_output_file_created"],
            ...
            "vision_model_runtime_active": screen_context["vision_model_runtime_active"],
            "ocr_runtime_active": screen_context["ocr_runtime_active"],
            ...
            "note": "Screen context adapter contract is ready for Sprint 203; it accepts only provided metadata/placeholder context and keeps screenshot capture, image file read, OCR, vision model runtime, redaction runtime, context handoff, chat handoff, visual actions, command/tool execution, memory writes, file/desktop/network/git actions, cloud fallback, and external upload disabled.",
        }
    ...
    def check(self) -> dict[str, Any]:
        ...
        assertions = {
            ...
            "screen_context_adapter_status_ready": screen_context["screen_context_adapter_status"] == "screen_context_adapter_contract_ready",
            "vision_runtime_block_start_201": screen_context["vision_runtime_block_start"] == 201,
            "vision_runtime_block_end_210": screen_context["vision_runtime_block_end"] == 210,
            "vision_runtime_current_sprint_203": screen_context["vision_runtime_current_sprint"] == 203,
            "vision_runtime_next_sprint_204": screen_context["vision_runtime_next_sprint"] == 204,
            "vision_runtime_next_boundary_local_vision_model_adapter": screen_context["vision_runtime_next_boundary"] == "local_vision_model_adapter",
            "previous_activation_contract_ready": screen_context["previous_activation_contract_ready"] is True,
            "previous_screenshot_contract_ready": screen_context["previous_explicit_screenshot_capture_contract_ready"] is True,
            "previous_screenshot_runtime_not_ready": screen_context["previous_explicit_screenshot_capture_runtime_ready"] is False,
            "previous_screenshot_not_performed": screen_context["previous_screenshot_capture_performed"] is False,
            "previous_screenshot_handoff_inactive": screen_context["previous_screenshot_to_context_handoff_active"] is False,
            "vision_runtime_not_ready": screen_context["runtime_ready"] is False,
            "vision_runtime_activation_not_allowed": screen_context["runtime_activation_allowed"] is False,
            "vision_release_gate_closed": screen_context["release_gate_open"] is False,
            "screen_context_adapter_contract_only": screen_context["screen_context_adapter_contract_only"] is True,
            "provided_screenshot_context_required": screen_context["provided_screenshot_context_required"] is True,
            "provided_screen_metadata_required": screen_context["provided_screen_metadata_required"] is True,
            "provided_user_prompt_required": screen_context["provided_user_prompt_required"] is True,
            "provided_redaction_notes_required": screen_context["provided_redaction_notes_required"] is True,
            "placeholder_context_only": screen_context["placeholder_context_only"] is True,
            "contract_input_only": screen_context["contract_input_only"] is True,
            "image_file_read_not_allowed": screen_context["image_file_read_allowed"] is False,
            "screenshot_capture_not_required_now": screen_context["screenshot_capture_required_now"] is False,
            "screenshot_file_read_not_required_now": screen_context["screenshot_file_read_required_now"] is False,
            "screen_context_input_schema_ready": screen_context["screen_context_input_schema_ready"] is True,
            "screen_context_metadata_schema_ready": screen_context["screen_context_metadata_schema_ready"] is True,
            "screen_context_packet_schema_ready": screen_context["screen_context_packet_schema_ready"] is True,
            "screen_context_summary_contract_ready": screen_context["screen_context_summary_contract_ready"] is True,
            "screen_context_source_metadata_required": screen_context["screen_context_source_metadata_required"] is True,
            "screen_context_uncertainty_required": screen_context["screen_context_uncertainty_required"] is True,
            "screen_context_no_visual_claims_without_model": screen_context["screen_context_no_visual_claims_without_model"] is True,
            "screen_context_no_ocr_claims_without_ocr": screen_context["screen_context_no_ocr_claims_without_ocr"] is True,
            "screen_context_no_identity_claims": screen_context["screen_context_no_identity_claims"] is True,
            "screen_context_no_action_bypass": screen_context["screen_context_no_action_bypass"] is True,
            "permission_required_before_screen_context_adapter": screen_context["permission_required_before_screen_context_adapter"] is True,
            "permission_required_before_context_handoff": screen_context["permission_required_before_context_handoff"] is True,
            "permission_required_before_chat_handoff": screen_context["permission_required_before_chat_handoff"] is True,
            "redaction_required_before_context_adapter": screen_context["redaction_required_before_context_adapter"] is True,
            "redaction_required_before_context_packet": screen_context["redaction_required_before_context_packet"] is True,
            "redaction_required_before_chat_handoff": screen_context["redaction_required_before_chat_handoff"] is True,
            "sensitive_region_redaction_required": screen_context["sensitive_region_redaction_required"] is True,
            "window_title_redaction_required": screen_context["window_title_redaction_required"] is True,
            "url_redaction_required": screen_context["url_redaction_required"] is True,
            "clipboard_exclusion_required": screen_context["clipboard_exclusion_required"] is True,
            "screen_context_runtime_not_ready": screen_context["screen_context_runtime_ready"] is False,
            "screen_context_adapter_inactive": screen_context["screen_context_adapter_active"] is False,
            "screen_context_input_not_received": screen_context["screen_context_input_received"] is False,
            "screen_context_metadata_not_received": screen_context["screen_context_metadata_received"] is False,
            "screen_context_packet_not_created": screen_context["screen_context_packet_created"] is False,
            "screen_context_summary_not_created": screen_context["screen_context_summary_created"] is False,
            "screen_context_handoff_inactive": screen_context["screen_context_handoff_active"] is False,
            "screen_context_to_chat_handoff_inactive": screen_context["screen_context_to_chat_handoff_active"] is False,
            "screenshot_to_context_handoff_inactive": screen_context["screenshot_to_context_handoff_active"] is False,
            "screenshot_capture_not_performed": screen_context["screenshot_capture_performed"] is False,
            "screenshot_output_file_not_created": screen_context["screenshot_output_file_created"] is False,
            "screenshot_file_write_inactive": screen_context["screenshot_file_write_active"] is False,
            "screenshot_file_read_inactive": screen_context["screenshot_file_read_active"] is False,
            "screenshot_storage_persistence_disabled": screen_context["screenshot_storage_persistence_enabled"] is False,
            "screenshot_metadata_persistence_disabled": screen_context["screenshot_metadata_persistence_enabled"] is False,
            "redaction_runtime_inactive": screen_context["redaction_runtime_active"] is False,
            "redacted_context_not_created": screen_context["redacted_context_created"] is False,
            "context_persistence_disabled": screen_context["context_persistence_enabled"] is False,
            "metadata_persistence_disabled": screen_context["metadata_persistence_enabled"] is False,
            "screen_context_memory_write_disabled": screen_context["screen_context_memory_write_enabled"] is False,
            "vision_model_runtime_inactive": screen_context["vision_model_runtime_active"] is False,
            "ocr_runtime_inactive": screen_context["ocr_runtime_active"] is False,
            "image_analysis_runtime_inactive": screen_context["image_analysis_runtime_active"] is False,
            "object_detection_runtime_inactive": screen_context["object_detection_runtime_active"] is False,
            "visual_action_execution_inactive": screen_context["visual_action_execution_active"] is False,
            "visual_tool_execution_inactive": screen_context["visual_tool_execution_active"] is False,
            "command_execution_inactive": screen_context["command_execution_active"] is False,
            "file_mutation_inactive": screen_context["file_mutation_active"] is False,
            "desktop_action_inactive": screen_context["desktop_action_active"] is False,
            "network_action_inactive": screen_context["network_action_active"] is False,
            "git_action_inactive": screen_context["git_action_active"] is False,
            "memory_write_inactive": screen_context["memory_write_active"] is False,
            "cloud_vision_fallback_disabled": screen_context["cloud_vision_fallback_enabled"] is False,
            "external_upload_disabled": screen_context["external_upload_enabled"] is False,
            "dependency_install_not_performed": screen_context["dependency_install_performed"] is False,
            "model_download_not_performed": screen_context["model_download_performed"] is False,
            "vision_safety_blocker_count": screen_context["safety_blocker_count"] == 33,
            "vision_all_safety_blockers_inactive": screen_context["all_safety_blockers_inactive"] is True,
        }

        for blocker in screen_context["safety_blockers"]:
            assertions[f"safety_blocker_{blocker}_inactive"] = screen_context[blocker] is False
        ...
        return {
            ...
            "explicit_screenshot_capture_contract": screenshot,
            "screen_context_adapter_contract": screen_context,
            "note": "Runtime is not enabled yet. This check prepared the Sprint 203 screen context adapter contract without capturing the screen, reading image files, creating context packets, running redaction runtime, OCR, vision models, context/chat handoff, tools/commands, memory writes, desktop actions, network/git actions, cloud vision, external upload, or visual actions.",
        }
