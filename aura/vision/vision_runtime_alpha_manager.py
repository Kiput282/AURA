...
class VisionRuntimeAlphaManager:
    ...
    def status(self) -> dict[str, Any]:
        ...
        integration_review = self.planner.vision_runtime_integration_review_contract()
        stabilization = self.planner.vision_runtime_stabilization_contract()
        ...
        return {
            ...
            "sprint_209_vision_runtime_integration_review_contract_ready": integration_review["vision_runtime_integration_review_contract_ready"],
            "sprint_210_vision_runtime_stabilization_contract_ready": stabilization["vision_runtime_stabilization_contract_ready"],
            ...
            "previous_contract_chain_complete": stabilization["previous_contract_chain_complete"],
            ...
            "runtime_activation_path_open": stabilization["runtime_activation_path_open"],
            ...
            "previous_contract_chain_complete": integration_review["previous_contract_chain_complete"],
            ...
            "note": "Vision Runtime Alpha is online for Sprint 210 Vision Runtime Stabilization contract. It closes Sprint 201-210 as contract-only stable and prepares the handoff to Sprint 211 without activating vision runtime, opening release gates, capturing screenshots, reading image files, running OCR, requesting models, injecting chat context, rendering panels, creating routes/API endpoints, fetching data, mutating permissions, writing audit events, uploading externally, or executing commands automatically.",
        }
