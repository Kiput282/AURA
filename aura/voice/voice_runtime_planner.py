...
class VoiceRuntimePlanner:
    ...
    def status(self) -> dict[str, Any]:
        ...
        return {
            ...
            "note": "Control Center voice controls contract is ready as read-only and disabled by default; no UI control triggers microphone capture, STT, TTS, speaker playback, permission mutation, audit writes, or voice actions.",
        }
    ...
    def check(self) -> dict[str, Any]:
        ...
        return {
            ...
            "voice_permission_audit_runtime_contract": voice_permission_audit,
            "control_center_voice_controls_contract": control_center_voice,
            "note": "Runtime is not enabled yet. This check did not activate Control Center voice controls, grant permissions, mutate permission state, write audit events, access microphone/speaker/playback devices, use STT/TTS models, cloud STT/TTS, transcript chat handoff, tools, commands, memory, files, or voice actions.",
        }
