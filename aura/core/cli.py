...
class AuraCLI:
    ...
    def vision_runtime_status(self) -> None:
        ...
        print(f"User Image First          : {status['vision_user_provided_image_first']}")
        print(f"Single Capture Only       : {status['single_capture_only']}")
        print(f"Continuous Capture Allowed: {status['continuous_capture_allowed']}")
        print(f"Background Capture Allowed: {status['background_capture_allowed']}")
        print(f"Silent Capture Allowed    : {status['silent_capture_allowed']}")
        print(f"Automatic Capture Allowed : {status['automatic_capture_allowed']}")
        ...
        print(f"Screenshot Candidates     : {status['screenshot_candidate_count']}")
        print(f"Screenshot Runtime Ready  : {status['screenshot_capture_runtime_ready']}")
        print(f"Screenshot Capture Active : {status['screenshot_capture_active']}")
        ...
        print(f"Screenshot Context Handoff: {status['screenshot_to_context_handoff_active']}")
        print(f"Provided Screenshot Context: {status['provided_screenshot_context_required']}")
        print(f"Provided Screen Metadata  : {status['provided_screen_metadata_required']}")
        print(f"Placeholder Context Only  : {status['placeholder_context_only']}")
        print(f"Screen Context Input Schema: {status['screen_context_input_schema_ready']}")
        print(f"Screen Context Packet Schema: {status['screen_context_packet_schema_ready']}")
        print(f"Screen Context Summary Contract: {status['screen_context_summary_contract_ready']}")
        print(f"Redaction Before Adapter  : {status['redaction_required_before_context_adapter']}")
        print(f"Redaction Before Packet   : {status['redaction_required_before_context_packet']}")
        print(f"Screen Context Adapter Active: {status['screen_context_adapter_active']}")
        print(f"Screen Context Input Received: {status['screen_context_input_received']}")
        ...
        print(f"Screen Context Chat Handoff: {status['screen_context_to_chat_handoff_active']}")
        print(f"Local First Required      : {status['local_first_required']}")
        print(f"Offline First Required    : {status['offline_first_required']}")
        print(f"Local Provider Contract   : {status['local_provider_contract_ready']}")
        print(f"Local Provider Count      : {status['supported_local_provider_count']}")
        print(f"Local Vision Candidate Count: {status['local_vision_model_candidate_count']}")
        print(f"Local Vision Candidates Ready: {status['local_vision_model_candidates_ready']}")
        print(f"Local Vision Default Candidate: {status['local_vision_model_default_candidate']}")
        print(f"Model Request Schema      : {status['model_request_schema_ready']}")
        print(f"Model Response Schema     : {status['model_response_schema_ready']}")
        print(f"Permission Before Model Request: {status['permission_required_before_model_request']}")
        print(f"Redaction Before Model Request : {status['redaction_required_before_model_request']}")
        print(f"No Raw Screenshot To Model: {status['no_raw_screenshot_to_model']}")
        print(f"No Unredacted Context To Model: {status['no_unredacted_context_to_model']}")
        print(f"Model Download Required Now: {status['model_download_required_now']}")
        print(f"Model Download Performed  : {status['model_download_performed']}")
        print(f"Local Vision Adapter Active: {status['local_vision_model_adapter_active']}")
        print(f"Local Provider Probe Active: {status['local_model_provider_probe_active']}")
        ...
        print(f"Local Model Response Created: {status['local_model_response_created']}")
        print(f"Model Chat Handoff Active : {status['model_to_chat_handoff_active']}")
        print(f"Explicit Visual Permission: {status['explicit_visual_permission_required']}")
        print(f"Explicit Visual Confirmation: {status['explicit_visual_confirmation_required']}")
        print(f"Foreground Only Required  : {status['foreground_only_required']}")
        print(f"Per Request Permission    : {status['per_request_permission_required']}")
        print(f"Permission Packet Schema  : {status['permission_packet_schema_ready']}")
        print(f"Permission Scope Schema   : {status['permission_scope_schema_ready']}")
        print(f"Permission Decision Schema: {status['permission_decision_schema_ready']}")
        print(f"Permission Expiry Schema  : {status['permission_expiry_schema_ready']}")
        print(f"Audit Event Schema        : {status['audit_event_schema_ready']}")
        print(f"Redaction Policy Schema   : {status['redaction_policy_schema_ready']}")
        print(f"Redaction Preview Schema  : {status['redaction_preview_schema_ready']}")
        print(f"Redaction Scope Schema    : {status['redaction_scope_schema_ready']}")
        print(f"Sensitive Region Redaction: {status['sensitive_region_redaction_required']}")
        print(f"Window Title Redaction    : {status['window_title_redaction_required']}")
        print(f"URL Redaction             : {status['url_redaction_required']}")
        print(f"Clipboard Exclusion       : {status['clipboard_exclusion_required']}")
        print(f"Secret Token Redaction    : {status['secret_token_redaction_required']}")
        print(f"Personal Identifier Redaction: {status['personal_identifier_redaction_required']}")
        print(f"Visible Text Redaction    : {status['visible_text_redaction_required']}")
        ...
        print(f"Redaction Preview Created : {status['redaction_preview_created']}")
        ...
        print(f"No Clipboard Capture      : {status['no_clipboard_capture']}")
        print(f"No Sensitive Window Title Exposure: {status['no_sensitive_window_title_exposure']}")
        print(f"No URL Exposure           : {status['no_url_exposure']}")
    ...
    def vision_runtime_check(self) -> None:
        ...
        print(f"Activation Runtime Allowed: {activation['runtime_activation_allowed']}")
        print(f"Activation Release Gate   : {activation['release_gate_open']}")
        print()
        ...
        print(f"Screenshot Status      : {screenshot['explicit_screenshot_capture_status']}")
        print(f"Screenshot Capture Performed: {screenshot['screenshot_capture_performed']}")
        print(f"Screenshot Context Handoff  : {screenshot['screenshot_to_context_handoff_active']}")
        print()
        ...
        print(f"Screen Context Status   : {screen_context['screen_context_adapter_status']}")
        print(f"Screen Context Packet Created: {screen_context['screen_context_packet_created']}")
        print(f"Screen Context Handoff  : {screen_context['screen_context_handoff_active']}")
        print()
        ...
        print(f"Local Model Status      : {local_model['local_vision_model_adapter_status']}")
        ...
        print(f"Model To Chat Handoff      : {local_model['model_to_chat_handoff_active']}")
        print()
        ...
        print(f"Vision Block Start           : {permission_redaction['vision_runtime_block_start']}")
        print(f"Vision Block End             : {permission_redaction['vision_runtime_block_end']}")
        print(f"Current Sprint               : {permission_redaction['vision_runtime_current_sprint']}")
        print(f"Next Sprint                  : {permission_redaction['vision_runtime_next_sprint']}")
        print(f"Next Boundary                : {permission_redaction['vision_runtime_next_boundary']}")
        print(f"Runtime Ready                : {permission_redaction['runtime_ready']}")
        print(f"Runtime Activation           : {permission_redaction['runtime_activation_allowed']}")
        print(f"Release Gate Open            : {permission_redaction['release_gate_open']}")
        print(f"Contract Only                : {permission_redaction['vision_permission_redaction_contract_only']}")
        print(f"Explicit Visual Permission   : {permission_redaction['explicit_visual_permission_required']}")
        print(f"Explicit Visual Confirmation : {permission_redaction['explicit_visual_confirmation_required']}")
        print(f"Foreground Only Required     : {permission_redaction['foreground_only_required']}")
        print(f"Single Capture Permission    : {permission_redaction['single_capture_permission_scope']}")
        print(f"Per Request Permission       : {permission_redaction['per_request_permission_required']}")
        print(f"Permission Packet Schema     : {permission_redaction['permission_packet_schema_ready']}")
        print(f"Permission Scope Schema      : {permission_redaction['permission_scope_schema_ready']}")
        print(f"Permission Decision Schema   : {permission_redaction['permission_decision_schema_ready']}")
        print(f"Permission Expiry Schema     : {permission_redaction['permission_expiry_schema_ready']}")
        print(f"Audit Event Schema           : {permission_redaction['audit_event_schema_ready']}")
        print(f"Redaction Policy Schema      : {permission_redaction['redaction_policy_schema_ready']}")
        print(f"Redaction Preview Schema     : {permission_redaction['redaction_preview_schema_ready']}")
        print(f"Redaction Scope Schema       : {permission_redaction['redaction_scope_schema_ready']}")
        print(f"Sensitive Region Redaction   : {permission_redaction['sensitive_region_redaction_required']}")
        print(f"Window Title Redaction       : {permission_redaction['window_title_redaction_required']}")
        print(f"URL Redaction                : {permission_redaction['url_redaction_required']}")
        print(f"Clipboard Exclusion          : {permission_redaction['clipboard_exclusion_required']}")
        print(f"Secret Token Redaction       : {permission_redaction['secret_token_redaction_required']}")
        print(f"Personal Identifier Redaction: {permission_redaction['personal_identifier_redaction_required']}")
        print(f"Visible Text Redaction       : {permission_redaction['visible_text_redaction_required']}")
        print(f"Permission Before Visual Input: {permission_redaction['permission_required_before_visual_input']}")
        print(f"Permission Before Screenshot : {permission_redaction['permission_required_before_screenshot']}")
        print(f"Permission Before Screen Context: {permission_redaction['permission_required_before_screen_context']}")
        print(f"Permission Before Model Adapter: {permission_redaction['permission_required_before_model_adapter']}")
        print(f"Permission Before Model Request: {permission_redaction['permission_required_before_model_request']}")
        print(f"Permission Before Chat Handoff: {permission_redaction['permission_required_before_chat_handoff']}")
        print(f"Permission Before Visual Action: {permission_redaction['permission_required_before_visual_action']}")
        print(f"Redaction Before Context Adapter: {permission_redaction['redaction_required_before_context_adapter']}")
        print(f"Redaction Before Context Packet : {permission_redaction['redaction_required_before_context_packet']}")
        print(f"Redaction Before Model Request  : {permission_redaction['redaction_required_before_model_request']}")
        print(f"Redaction Before Model Response : {permission_redaction['redaction_required_before_model_response']}")
        print(f"Redaction Before Chat Handoff   : {permission_redaction['redaction_required_before_chat_handoff']}")
        print(f"Redaction Before Memory Write   : {permission_redaction['redaction_required_before_memory_write']}")
        print(f"No Raw Screenshot To Model      : {permission_redaction['no_raw_screenshot_to_model']}")
        print(f"No Raw Screenshot To Chat       : {permission_redaction['no_raw_screenshot_to_chat']}")
        print(f"No Unredacted Context To Model  : {permission_redaction['no_unredacted_context_to_model']}")
        print(f"No Unredacted Context To Chat   : {permission_redaction['no_unredacted_context_to_chat']}")
        print(f"No Clipboard Capture            : {permission_redaction['no_clipboard_capture']}")
        print(f"No Sensitive Window Title Exposure: {permission_redaction['no_sensitive_window_title_exposure']}")
        print(f"No URL Exposure                 : {permission_redaction['no_url_exposure']}")
        print(f"No Identity Claims              : {permission_redaction['no_identity_claims']}")
        print(f"No Biometric Identification     : {permission_redaction['no_biometric_identification']}")
        print(f"No Face Recognition             : {permission_redaction['no_face_recognition']}")
        print(f"No Emotion Inference From Face  : {permission_redaction['no_emotion_inference_from_face']}")
        print(f"Image File Read Allowed         : {permission_redaction['image_file_read_allowed']}")
        print(f"Screenshot Required Now         : {permission_redaction['screenshot_capture_required_now']}")
        print(f"Screenshot File Read Now        : {permission_redaction['screenshot_file_read_required_now']}")
        print(f"OCR Required Now                : {permission_redaction['ocr_required_now']}")
        print(f"Cloud Vision Fallback Allowed   : {permission_redaction['cloud_vision_fallback_allowed']}")
        print(f"External Upload Allowed         : {permission_redaction['external_upload_allowed']}")
        print(f"Model Download Required Now     : {permission_redaction['model_download_required_now']}")
        print(f"Dependency Install              : {permission_redaction['dependency_install_performed']}")
        print(f"Safety Blocker Count            : {permission_redaction['safety_blocker_count']}")
        print(f"All Safety Blockers Off         : {permission_redaction['all_safety_blockers_inactive']}")
        print(f"Runtime Scope                   : {permission_redaction['runtime_scope']}")
        print()
        print("Vision Permission and Redaction Runtime Safety State")
        print("---------------------------------------------------")
        print(f"Permission Prompt Runtime       : {permission_redaction['permission_prompt_runtime_active']}")
        print(f"Permission Grant Mutation       : {permission_redaction['permission_grant_mutation_active']}")
        print(f"Redaction Runtime               : {permission_redaction['redaction_runtime_active']}")
        print(f"Redaction Preview Created       : {permission_redaction['redaction_preview_created']}")
        print(f"Redacted Context Created        : {permission_redaction['redacted_context_created']}")
        print(f"Redaction Audit Write           : {permission_redaction['redaction_audit_write_active']}")
        print(f"Screen Capture Runtime Ready    : {permission_redaction['screen_capture_runtime_ready']}")
        print(f"Screenshot Capture Performed    : {permission_redaction['screenshot_capture_performed']}")
        print(f"Screenshot Output Created       : {permission_redaction['screenshot_output_file_created']}")
        print(f"Screenshot File Read            : {permission_redaction['screenshot_file_read_active']}")
        print(f"Screen Context Packet Created   : {permission_redaction['screen_context_packet_created']}")
        print(f"Screen Context Handoff          : {permission_redaction['screen_context_handoff_active']}")
        print(f"Local Vision Adapter Active     : {permission_redaction['local_vision_model_adapter_active']}")
        print(f"Local Provider Probe Active     : {permission_redaction['local_model_provider_probe_active']}")
        print(f"Local Model Request Active      : {permission_redaction['local_model_request_active']}")
        print(f"Local Model Inference Active    : {permission_redaction['local_model_inference_active']}")
        print(f"Model To Chat Handoff           : {permission_redaction['model_to_chat_handoff_active']}")
        print(f"Vision Model Runtime            : {permission_redaction['vision_model_runtime_active']}")
        print(f"OCR Runtime Active              : {permission_redaction['ocr_runtime_active']}")
        print(f"Image Analysis Runtime          : {permission_redaction['image_analysis_runtime_active']}")
        print(f"Object Detection Runtime        : {permission_redaction['object_detection_runtime_active']}")
        print(f"Visual Action Execution         : {permission_redaction['visual_action_execution_active']}")
        print(f"Visual Tool Execution           : {permission_redaction['visual_tool_execution_active']}")
        print(f"Command Execution               : {permission_redaction['command_execution_active']}")
        print(f"File Mutation                   : {permission_redaction['file_mutation_active']}")
        print(f"Desktop Action                  : {permission_redaction['desktop_action_active']}")
        print(f"Network Action                  : {permission_redaction['network_action_active']}")
        print(f"Git Action                      : {permission_redaction['git_action_active']}")
        print(f"Memory Write                    : {permission_redaction['memory_write_active']}")
        print(f"Cloud Vision Fallback           : {permission_redaction['cloud_vision_fallback_enabled']}")
        print(f"External Upload                 : {permission_redaction['external_upload_enabled']}")
        print(f"Visual Context Action Bypass    : {permission_redaction['visual_context_to_action_bypass_enabled']}")
        print(f"No Tool Use From Visual Context : {permission_redaction['no_tool_use_from_visual_context']}")
        print(f"No Autonomous Action            : {permission_redaction['no_autonomous_action']}")
        print()
        print("Vision Safety Blockers")
        print("----------------------")
        for blocker in permission_redaction["safety_blockers"]:
            print(f"- {blocker}")
        print()
        print("Failed Assertions")
        print("-----------------")
