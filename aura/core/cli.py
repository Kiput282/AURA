...
class AuraCLI:
    ...
    def active_permission_runtime_alpha_status(self) -> None:
        ...
        print("AURA Safe Local Open Actions Alpha")
        print("==================================")

        def row(label: str, key: str, fallback: object = "n/a") -> None:
            print(f"{label:<36}: {status.get(key, fallback)}")
        ...
        rows = [
            ...
            ("Sprint 211 Contract Ready", "active_permission_runtime_contract_ready"),
            ...
            ("S215 Safe Open Runtime", "safe_local_open_actions_runtime_ready"),
            ("S215 Safe Open Status", "safe_local_open_actions_status"),
            ...
            ("Preview Before Open Required", "preview_before_open_required"),
            ("Explicit Approval Before Open", "explicit_approval_before_open_required"),
            ("Permission Before Open Required", "permission_before_open_required"),
            ("Audit Correlation Before Open", "audit_correlation_before_open_required"),
            ("Allowlist Before Open Required", "allowlist_before_open_required"),
            ("Safe Open Request Schema", "safe_local_open_request_schema_ready"),
            ("Safe Open Target Schema", "safe_local_open_target_schema_ready"),
            ("Safe Open Preview Schema", "safe_local_open_preview_schema_ready"),
            ("Safe Open Allowlist Schema", "safe_local_open_allowlist_schema_ready"),
            ("Safe Open User Preview Schema", "safe_local_open_user_visible_preview_schema_ready"),
            ("Safe Open Approval Handoff Schema", "safe_local_open_approval_handoff_schema_ready"),
            ("Safe Open Review Queue Schema", "safe_local_open_review_queue_schema_ready"),
            ("Allowed Safe Open Target Count", "allowed_safe_open_target_count"),
            ("Blocked Safe Open Target Count", "blocked_safe_open_target_count"),
            ("Local Open Action Runtime", "local_open_action_runtime_ready"),
            ("Safe Open Request Creation", "safe_local_open_request_creation_allowed"),
            ("Safe Open Preview Creation", "safe_local_open_preview_creation_allowed"),
            ("Safe Open Dispatch", "safe_local_open_dispatch_allowed"),
            ("Approved Folder Open Runtime", "approved_folder_open_runtime_ready"),
            ("Approved File Open Runtime", "approved_file_open_runtime_ready"),
            ("Project Location Open Runtime", "project_location_open_runtime_ready"),
            ("Dashboard Open Runtime", "dashboard_open_runtime_ready"),
            ("Path Access Runtime", "path_access_runtime_ready"),
            ("File Read Runtime", "file_read_runtime_ready"),
            ("Directory Listing Runtime", "directory_listing_runtime_ready"),
            ("Shell Open Dispatch", "shell_open_dispatch_allowed"),
            ("Browser Open Dispatch", "safe_local_open_dispatch_allowed"),
            ("File Manager Launch", "file_manager_launch_allowed"),
            ...
            ("Approved Folder Opened", "approved_folder_opened"),
            ("Approved File Opened", "approved_file_opened"),
            ("Project Location Opened", "project_location_opened"),
            ("Dashboard Opened", "dashboard_opened"),
            ("Path Accessed", "path_accessed"),
            ...
            ("No Approved Folder Open", "no_approved_folder_open"),
            ("No Approved File Open", "no_approved_file_open"),
            ("No Dashboard Open", "no_dashboard_open"),
            ("No Path Access", "no_path_access"),
            ("No File Read", "no_file_read"),
            ("No Directory Listing", "no_directory_listing"),
            ("No Open Without Preview", "no_open_without_preview"),
            ("No Open Without Approval", "no_open_without_explicit_approval"),
            ("No Open Arbitrary Path", "no_open_arbitrary_path"),
    ...
    def active_permission_runtime_status(self) -> None:
        ...
        print("AURA Safe Local Open Actions Status")
        print("===================================")

        def row(label: str, key: str, fallback: object = "n/a") -> None:
            print(f"{label:<40}: {status.get(key, fallback)}")
        ...
        rows = [
            ...
            ("Planning Ready", "planning_ready"),
            ("Runtime Ready", "runtime_ready"),
            ("Contract Ready", "safe_local_open_actions_contract_ready"),
            ("S215 Safe Open Ready", "safe_local_open_actions_contract_ready"),
            ("S215 Safe Open Runtime", "safe_local_open_actions_runtime_ready"),
            ("S215 Safe Open Status", "safe_local_open_actions_status"),
            ("Current Sprint", "permission_action_current_sprint"),
            ("Next Sprint", "permission_action_next_sprint"),
            ...
            ("Audit Correlation Before Open", "audit_correlation_before_open_required"),
            ("Allowlist Before Open Required", "allowlist_before_open_required"),
            ("Canonical Path Before Open", "canonical_path_before_open_required"),
            ("Safe Scope Before Open", "safe_local_scope_before_open_required"),
            ("Single Open Action Required", "single_open_action_required"),
            ("Safe Open Request Schema", "safe_local_open_request_schema_ready"),
            ("Safe Open Target Schema", "safe_local_open_target_schema_ready"),
            ("Safe Open Preview Schema", "safe_local_open_preview_schema_ready"),
            ("Safe Open Path Policy Schema", "safe_local_open_path_policy_schema_ready"),
            ("Safe Open Allowlist Schema", "safe_local_open_allowlist_schema_ready"),
            ("Safe Open Permission Requirement Schema", "safe_local_open_permission_requirement_schema_ready"),
            ("Safe Open Audit Correlation Schema", "safe_local_open_audit_correlation_schema_ready"),
            ("Safe Open User Preview Schema", "safe_local_open_user_visible_preview_schema_ready"),
            ("Safe Open Approval Handoff Schema", "safe_local_open_approval_handoff_schema_ready"),
            ("Safe Open Review Queue Schema", "safe_local_open_review_queue_schema_ready"),
            ("Allowed Safe Open Target Count", "allowed_safe_open_target_count"),
            ...
            ("Local Open Action Runtime", "local_open_action_runtime_ready"),
            ("Safe Open Request Creation", "safe_local_open_request_creation_allowed"),
            ("Safe Open Target Resolution", "safe_local_open_target_resolution_allowed"),
            ("Safe Open Preview Creation", "safe_local_open_preview_creation_allowed"),
            ("Safe Open Preview Render", "safe_local_open_preview_render_allowed"),
            ("Safe Open Approval Handoff", "safe_local_open_approval_handoff_allowed"),
            ("Safe Open Review Queue Enqueue", "safe_local_open_review_queue_enqueue_allowed"),
            ("Safe Open Dispatch", "safe_local_open_dispatch_allowed"),
            ("Approved Folder Open Runtime", "approved_folder_open_runtime_ready"),
            ("Approved File Open Runtime", "approved_file_open_runtime_ready"),
            ("Project Location Open Runtime", "project_location_open_runtime_ready"),
            ...
            ("Directory Listing Runtime", "directory_listing_runtime_ready"),
            ("Shell Open Dispatch", "shell_open_dispatch_allowed"),
            ("OS Open Dispatch", "os_open_dispatch_allowed"),
            ("Browser Open Dispatch", "browser_open_dispatch_allowed"),
            ("File Manager Launch", "file_manager_launch_allowed"),
            ("File Mutation Allowed", "file_mutation_allowed"),
            ("Desktop Action Allowed", "desktop_action_allowed"),
            ("Application Launch Allowed", "application_launch_allowed"),
            ("Safe Open Request Created", "safe_local_open_request_created"),
            ("Safe Open Preview Created", "safe_local_open_preview_packet_created"),
            ("Safe Open Approval Handoff Created", "safe_local_open_approval_handoff_created"),
            ("Safe Open Review Queue Item", "safe_local_open_review_queue_item_created"),
            ("Safe Open Action Executed", "safe_local_open_action_executed"),
            ("Approved Folder Opened", "approved_folder_opened"),
            ("Approved File Opened", "approved_file_opened"),
            ("Project Location Opened", "project_location_opened"),
            ("Dashboard Opened", "dashboard_opened"),
            ...
            ("File Read Performed", "file_read_performed"),
            ("Directory Listing Performed", "directory_listing_performed"),
            ("Shell Open Dispatched", "shell_open_dispatched"),
            ("OS Open Dispatched", "os_open_dispatched"),
            ("Browser Open Dispatched", "browser_open_dispatched"),
            ("File Manager Launched", "file_manager_launched"),
            ...
            ("No Safe Open Request Creation", "no_safe_local_open_request_creation"),
            ("No Safe Open Preview Creation", "no_safe_local_open_preview_creation"),
            ("No Safe Open Dispatch", "no_safe_local_open_dispatch"),
            ("No Approved Folder Open", "no_approved_folder_open"),
            ("No Approved File Open", "no_approved_file_open"),
            ("No Project Location Open", "no_project_location_open"),
            ("No Dashboard Open", "no_dashboard_open"),
            ("No Path Access", "no_path_access"),
            ("No File Read", "no_file_read"),
            ("No Directory Listing", "no_directory_listing"),
            ("No Open Without Preview", "no_open_without_preview"),
            ("No Open Without Approval", "no_open_without_explicit_approval"),
            ("No Open Without Permission", "no_open_without_permission"),
            ("No Open Without Audit Correlation", "no_open_without_audit_correlation"),
            ("No Open Non-Allowlisted Path", "no_open_non_allowlisted_path"),
            ("No Open Arbitrary Path", "no_open_arbitrary_path"),
            ("No Open Mutating Path", "no_open_mutating_path"),
            ("No File Mutation", "no_file_mutation"),
            ("No Desktop Action", "no_desktop_action"),
            ("No Application Launch", "no_application_launch"),
            ("Safety Blocker Count", "safety_blocker_count"),
    ...
    def active_permission_runtime_check(self) -> None:
        ...
        planner = ActivePermissionRuntimePlanner()
        check = planner.check()
        contract = check.get("safe_local_open_actions_contract", {})

        print("AURA Safe Local Open Actions Check")
        print("==================================")
        ...
        print()
        print("Sprint 215 Safe Local Open Actions")
        print("----------------------------------")

        def row(label: str, key: str) -> None:
            print(f"{label:<41}: {contract.get(key)}")

        sprint_rows = [
            ("Contract Ready", "safe_local_open_actions_contract_ready"),
            ("Runtime Ready", "safe_local_open_actions_runtime_ready"),
            ("Runtime Status", "safe_local_open_actions_status"),
            ("S215 Safe Open Ready", "safe_local_open_actions_contract_ready"),
            ("S215 Safe Open Runtime", "safe_local_open_actions_runtime_ready"),
            ("Current Sprint", "permission_action_current_sprint"),
            ("Next Sprint", "permission_action_next_sprint"),
            ...
            ("Allowed Safe Open Target Count", "allowed_safe_open_target_count"),
            ("Blocked Safe Open Target Count", "blocked_safe_open_target_count"),
            ("Safe Local Action Handoff", "safe_local_action_handoff_ready"),
            ("Local Open Action Runtime", "local_open_action_runtime_ready"),
            ("Safe Open Request Creation", "safe_local_open_request_creation_allowed"),
            ("Safe Open Target Resolution", "safe_local_open_target_resolution_allowed"),
            ("Safe Open Preview Creation", "safe_local_open_preview_creation_allowed"),
            ...
            ("Project Location Open Runtime", "project_location_open_runtime_ready"),
            ("Dashboard Open Runtime", "dashboard_open_runtime_ready"),
            ("Path Allowlist Resolution", "path_allowlist_resolution_allowed"),
            ("Path Canonicalization", "path_canonicalization_allowed"),
            ("Path Access Runtime", "path_access_runtime_ready"),
            ("File Read Runtime", "file_read_runtime_ready"),
            ("Directory Listing Runtime", "directory_listing_runtime_ready"),
            ("Shell Open Dispatch", "shell_open_dispatch_allowed"),
        ...
        print()
        print("Safe Local Open Actions Safety State")
        print("------------------------------------")

        safety_rows = [
            ("Safe Open Request Created", "safe_local_open_request_created"),
            ("Safe Open Target Created", "safe_local_open_target_packet_created"),
            ("Safe Open Preview Created", "safe_local_open_preview_packet_created"),
            ("Safe Open Path Policy Created", "safe_local_open_path_policy_created"),
            ("Safe Open Allowlist Created", "safe_local_open_allowlist_packet_created"),
            ("Safe Open Audit Correlation Created", "safe_local_open_audit_correlation_created"),
            ("Safe Open User Preview Created", "safe_local_open_user_visible_preview_created"),
            ("Safe Open Approval Handoff Created", "safe_local_open_approval_handoff_created"),
            ("Safe Open Review Queue Item", "safe_local_open_review_queue_item_created"),
            ("Safe Open Action Created", "safe_local_open_action_created"),
            ("Safe Open Action Enqueued", "safe_local_open_action_enqueued"),
            ("Safe Open Action Executed", "safe_local_open_action_executed"),
            ("Approved Folder Opened", "approved_folder_opened"),
            ("Approved File Opened", "approved_file_opened"),
            ("Project Location Opened", "project_location_opened"),
            ...
            ("Audit Event Written", "audit_event_written"),
            ("No Safe Open Request Creation", "no_safe_local_open_request_creation"),
            ("No Safe Open Target Resolution", "no_safe_local_open_target_resolution"),
            ("No Safe Open Preview Creation", "no_safe_local_open_preview_creation"),
            ("No Safe Open Preview Render", "no_safe_local_open_preview_render"),
            ("No Safe Open Approval Handoff", "no_safe_local_open_approval_handoff"),
            ("No Safe Open Review Queue Enqueue", "no_safe_local_open_review_queue_enqueue"),
            ("No Safe Open Dispatch", "no_safe_local_open_dispatch"),
            ("No Approved Folder Open", "no_approved_folder_open"),
            ("No Approved File Open", "no_approved_file_open"),
            ("No Project Location Open", "no_project_location_open"),
            ...
            ("No File Read", "no_file_read"),
            ("No Directory Listing", "no_directory_listing"),
            ("No Shell Open Dispatch", "no_shell_open_dispatch"),
            ("No OS Open Dispatch", "no_os_open_dispatch"),
            ("No Browser Open Dispatch", "no_browser_open_dispatch"),
            ("No File Manager Launch", "no_file_manager_launch"),
            ("No Open Without Preview", "no_open_without_preview"),
            ("No Open Without Approval", "no_open_without_explicit_approval"),
            ("No Open Without Permission", "no_open_without_permission"),
            ("No Open Without Audit Correlation", "no_open_without_audit_correlation"),
            ...
            ("No Open Arbitrary Path", "no_open_arbitrary_path"),
            ("No Open Mutating Path", "no_open_mutating_path"),
            ("No Open Network Path", "no_open_network_path"),
            ("No File Mutation", "no_file_mutation"),
            ("No Desktop Action", "no_desktop_action"),
            ("No Application Launch", "no_application_launch"),
            ("Safety Blocker Count", "safety_blocker_count"),
