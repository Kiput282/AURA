...
class AuraCLI:
    ...
    def vision_runtime_status(self) -> None:
        ...
        print(f"Active Window Schema      : {status['active_window_schema_ready']}")
        print(f"Visible Region Schema     : {status['visible_region_schema_ready']}")
        print(f"Visual Element Schema     : {status['visual_element_schema_ready']}")
        print(f"Attention Target Schema   : {status['attention_target_schema_ready']}")
        print(f"Workspace Risk Schema     : {status['workspace_risk_schema_ready']}")
        print(f"Limitation Schema         : {status['limitation_schema_ready']}")
        print(f"Workspace Overview Contract: {status['workspace_overview_contract_ready']}")
        print(f"Window Layout Contract    : {status['window_layout_contract_ready']}")
        print(f"Visible Region Contract   : {status['visible_region_contract_ready']}")
        print(f"UI Element Hint Contract  : {status['ui_element_hint_contract_ready']}")
        print(f"Task Context Contract     : {status['task_context_contract_ready']}")
        print(f"Risk Summary Contract     : {status['risk_summary_contract_ready']}")
        print(f"Uncertainty Summary Contract: {status['uncertainty_summary_contract_ready']}")
        print(f"Permission Before Workspace Understanding: {status['permission_required_before_workspace_understanding']}")
        print(f"Redaction Before Workspace Understanding: {status['redaction_required_before_workspace_understanding']}")
        print(f"Redaction Before Workspace Summary: {status['redaction_required_before_workspace_summary']}")
        print(f"No Raw Screenshot To Workspace: {status['no_raw_screenshot_to_workspace']}")
        print(f"No Unredacted Context To Workspace: {status['no_unredacted_context_to_workspace']}")
        print(f"No OCR Claims Without OCR: {status['no_ocr_claims_without_ocr']}")
        print(f"No Model Claims Without Model: {status['no_model_claims_without_model']}")
        ...
        print(f"Workspace Layout Created : {status['workspace_layout_created']}")
        print(f"Visual Element List Created: {status['visual_element_list_created']}")
        print(f"Attention Target Created : {status['attention_target_created']}")
        print(f"Workspace Risk Assessment: {status['workspace_risk_assessment_created']}")
    ...
    def vision_runtime_check(self) -> None:
        ...
        print(f"Vision Block Start             : {workspace_visual['vision_runtime_block_start']}")
        print(f"Vision Block End               : {workspace_visual['vision_runtime_block_end']}")
        print(f"Current Sprint                 : {workspace_visual['vision_runtime_current_sprint']}")
        print(f"Next Sprint                    : {workspace_visual['vision_runtime_next_sprint']}")
        print(f"Next Boundary                  : {workspace_visual['vision_runtime_next_boundary']}")
        print(f"Runtime Ready                  : {workspace_visual['runtime_ready']}")
        print(f"Runtime Activation             : {workspace_visual['runtime_activation_allowed']}")
        print(f"Release Gate Open              : {workspace_visual['release_gate_open']}")
        print(f"Contract Only                  : {workspace_visual['workspace_visual_understanding_contract_only']}")
        print(f"Provided Redacted Visual Context: {workspace_visual['provided_redacted_visual_context_required']}")
        print(f"Provided Screen Metadata       : {workspace_visual['provided_screen_metadata_required']}")
        print(f"Provided Workspace Metadata    : {workspace_visual['provided_workspace_metadata_required']}")
        print(f"Provided User Question         : {workspace_visual['provided_user_question_required']}")
        print(f"Provided Permission Packet     : {workspace_visual['provided_permission_packet_required']}")
        print(f"Redaction Proof Required       : {workspace_visual['redaction_proof_required']}")
        print(f"Source Metadata Required       : {workspace_visual['source_metadata_required']}")
        print(f"Uncertainty Required           : {workspace_visual['uncertainty_required']}")
        print(f"Workspace Summary Schema       : {workspace_visual['workspace_visual_summary_schema_ready']}")
        print(f"Workspace Layout Schema        : {workspace_visual['workspace_layout_schema_ready']}")
        print(f"Active Window Schema           : {workspace_visual['active_window_schema_ready']}")
        print(f"Visible Region Schema          : {workspace_visual['visible_region_schema_ready']}")
        print(f"Visual Element Schema          : {workspace_visual['visual_element_schema_ready']}")
        print(f"Attention Target Schema        : {workspace_visual['attention_target_schema_ready']}")
        print(f"Workspace Risk Schema          : {workspace_visual['workspace_risk_schema_ready']}")
        print(f"Limitation Schema              : {workspace_visual['limitation_schema_ready']}")
        print(f"Workspace Overview Contract    : {workspace_visual['workspace_overview_contract_ready']}")
        print(f"Window Layout Contract         : {workspace_visual['window_layout_contract_ready']}")
        print(f"Visible Region Contract        : {workspace_visual['visible_region_contract_ready']}")
        print(f"UI Element Hint Contract       : {workspace_visual['ui_element_hint_contract_ready']}")
        print(f"Task Context Contract          : {workspace_visual['task_context_contract_ready']}")
        print(f"Risk Summary Contract          : {workspace_visual['risk_summary_contract_ready']}")
        print(f"Uncertainty Summary Contract   : {workspace_visual['uncertainty_summary_contract_ready']}")
        print(f"Permission Before Workspace Understanding: {workspace_visual['permission_required_before_workspace_understanding']}")
        print(f"Permission Before Context Handoff: {workspace_visual['permission_required_before_context_handoff']}")
        print(f"Permission Before Chat Handoff : {workspace_visual['permission_required_before_chat_handoff']}")
        print(f"Redaction Before Workspace Understanding: {workspace_visual['redaction_required_before_workspace_understanding']}")
        print(f"Redaction Before Workspace Summary: {workspace_visual['redaction_required_before_workspace_summary']}")
        print(f"Redaction Before Context Handoff : {workspace_visual['redaction_required_before_context_handoff']}")
        print(f"Redaction Before Chat Handoff    : {workspace_visual['redaction_required_before_chat_handoff']}")
        print(f"No Raw Screenshot To Workspace   : {workspace_visual['no_raw_screenshot_to_workspace']}")
        print(f"No Raw Screenshot To Chat        : {workspace_visual['no_raw_screenshot_to_chat']}")
        print(f"No Unredacted Context To Workspace: {workspace_visual['no_unredacted_context_to_workspace']}")
        print(f"No Unredacted Context To Chat    : {workspace_visual['no_unredacted_context_to_chat']}")
        print(f"No OCR Claims Without OCR        : {workspace_visual['no_ocr_claims_without_ocr']}")
        print(f"No Model Claims Without Model    : {workspace_visual['no_model_claims_without_model']}")
        print(f"No Identity Claims               : {workspace_visual['no_identity_claims']}")
        print(f"No Biometric Identification      : {workspace_visual['no_biometric_identification']}")
        print(f"No Face Recognition              : {workspace_visual['no_face_recognition']}")
        print(f"No Emotion Inference From Face   : {workspace_visual['no_emotion_inference_from_face']}")
        print(f"No Action Recommendation Without Permission: {workspace_visual['no_action_recommendation_without_permission']}")
        print(f"Image File Read Allowed          : {workspace_visual['image_file_read_allowed']}")
        print(f"Screenshot Required Now          : {workspace_visual['screenshot_capture_required_now']}")
        print(f"Screenshot File Read Now         : {workspace_visual['screenshot_file_read_required_now']}")
        print(f"OCR Required Now                 : {workspace_visual['ocr_required_now']}")
        print(f"Cloud Vision Fallback Allowed    : {workspace_visual['cloud_vision_fallback_allowed']}")
        print(f"External Upload Allowed          : {workspace_visual['external_upload_allowed']}")
        print(f"Model Download Required Now      : {workspace_visual['model_download_required_now']}")
        print(f"Dependency Install               : {workspace_visual['dependency_install_performed']}")
        print(f"Safety Blocker Count             : {workspace_visual['safety_blocker_count']}")
        print(f"All Safety Blockers Off          : {workspace_visual['all_safety_blockers_inactive']}")
        print(f"Runtime Scope                    : {workspace_visual['runtime_scope']}")
        print()
        print("Workspace Visual Understanding Runtime Safety State")
        print("---------------------------------------------------")
        print(f"Workspace Understanding Runtime : {workspace_visual['workspace_visual_understanding_runtime_active']}")
        print(f"Workspace Summary Created       : {workspace_visual['workspace_visual_summary_created']}")
        print(f"Workspace Layout Created        : {workspace_visual['workspace_layout_created']}")
        print(f"Visual Element List Created     : {workspace_visual['visual_element_list_created']}")
        print(f"Attention Target Created        : {workspace_visual['attention_target_created']}")
        print(f"Workspace Risk Assessment       : {workspace_visual['workspace_risk_assessment_created']}")
        print(f"Workspace To Chat Handoff       : {workspace_visual['workspace_to_chat_handoff_active']}")
        print(f"Permission Prompt Runtime       : {workspace_visual['permission_prompt_runtime_active']}")
        print(f"Permission Grant Mutation       : {workspace_visual['permission_grant_mutation_active']}")
        print(f"Redaction Runtime               : {workspace_visual['redaction_runtime_active']}")
        print(f"Redaction Preview Created       : {workspace_visual['redaction_preview_created']}")
        print(f"Redacted Context Created        : {workspace_visual['redacted_context_created']}")
        print(f"Redaction Audit Write           : {workspace_visual['redaction_audit_write_active']}")
        print(f"Screenshot Capture Performed    : {workspace_visual['screenshot_capture_performed']}")
        print(f"Screenshot Output Created       : {workspace_visual['screenshot_output_file_created']}")
        print(f"Screenshot File Read            : {workspace_visual['screenshot_file_read_active']}")
        print(f"Screen Context Packet Created   : {workspace_visual['screen_context_packet_created']}")
        print(f"Screen Context Handoff          : {workspace_visual['screen_context_handoff_active']}")
        print(f"Local Vision Adapter Active     : {workspace_visual['local_vision_model_adapter_active']}")
        print(f"Local Provider Probe Active     : {workspace_visual['local_model_provider_probe_active']}")
        print(f"Local Model Request Active      : {workspace_visual['local_model_request_active']}")
        print(f"Local Model Inference Active    : {workspace_visual['local_model_inference_active']}")
        print(f"Model To Chat Handoff           : {workspace_visual['model_to_chat_handoff_active']}")
        print(f"Vision Model Runtime            : {workspace_visual['vision_model_runtime_active']}")
        print(f"OCR Runtime Active              : {workspace_visual['ocr_runtime_active']}")
        print(f"Image Analysis Runtime          : {workspace_visual['image_analysis_runtime_active']}")
        print(f"Object Detection Runtime        : {workspace_visual['object_detection_runtime_active']}")
        print(f"Visual Action Execution         : {workspace_visual['visual_action_execution_active']}")
        print(f"Visual Tool Execution           : {workspace_visual['visual_tool_execution_active']}")
        print(f"Command Execution               : {workspace_visual['command_execution_active']}")
        print(f"Memory Write                    : {workspace_visual['memory_write_active']}")
        print(f"Cloud Vision Fallback           : {workspace_visual['cloud_vision_fallback_enabled']}")
        print(f"External Upload                 : {workspace_visual['external_upload_enabled']}")
        print(f"Visual Context Action Bypass    : {workspace_visual['visual_context_to_action_bypass_enabled']}")
        print(f"No Tool Use From Visual Context : {workspace_visual['no_tool_use_from_visual_context']}")
        print(f"No Autonomous Action            : {workspace_visual['no_autonomous_action']}")
        print()
