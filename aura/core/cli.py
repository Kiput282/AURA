...
class AuraCLI:
    ...
    def active_permission_runtime_alpha_status(self) -> None:
        ...
        print("AURA Allowlisted Application Launch Alpha")
        print("=========================================")

        def row(label: str, key: str, fallback: object = "n/a") -> None:
            print(f"{label:<42}: {status.get(key, fallback)}")
        ...
        rows = [
            ...
            ("S215 Safe Open Ready", "sprint_215_safe_local_open_actions_contract_ready"),
            ("S216 App Launch Ready", "sprint_216_allowlisted_application_launch_contract_ready"),
            ("S216 App Launch Runtime", "allowlisted_application_launch_runtime_ready"),
            ("S216 App Launch Status", "allowlisted_application_launch_status"),
            ...
            ("Preview Before Launch Required", "preview_before_launch_required"),
            ("Explicit Approval Before Launch", "explicit_approval_before_launch_required"),
            ("Permission Before Launch Required", "permission_before_launch_required"),
            ("Audit Correlation Before Launch", "audit_correlation_before_launch_required"),
            ("Allowlist Before Launch Required", "allowlist_before_launch_required"),
            ("Application Identity Before Launch", "application_identity_before_launch_required"),
            ("Safe Arguments Before Launch", "safe_arguments_before_launch_required"),
            ("Application Launch Request Schema", "application_launch_request_schema_ready"),
            ("Application Launch Target Schema", "application_launch_target_schema_ready"),
            ("Application Launch Preview Schema", "application_launch_preview_schema_ready"),
            ("Application Launch Allowlist Schema", "application_launch_allowlist_schema_ready"),
            ("Application Launch User Preview Schema", "application_launch_user_visible_preview_schema_ready"),
            ("Application Launch Approval Schema", "application_launch_approval_handoff_schema_ready"),
            ("Application Launch Review Queue Schema", "application_launch_review_queue_schema_ready"),
            ("Allowed App Launch Profile Count", "allowed_application_launch_profile_count"),
            ("Blocked App Launch Target Count", "blocked_application_launch_target_count"),
            ("Application Launch Runtime", "application_launch_runtime_ready"),
            ("Application Launch Request Creation", "application_launch_request_creation_allowed"),
            ("Application Launch Preview Creation", "application_launch_preview_creation_allowed"),
            ("Application Launch Dispatch", "application_launch_dispatch_allowed"),
            ("Application Allowlist Resolution", "application_allowlist_resolution_allowed"),
            ("Application Identity Validation", "application_identity_validation_allowed"),
            ("Application Executable Resolution", "application_executable_resolution_allowed"),
            ("Application Process Spawn", "application_process_spawn_allowed"),
            ("Approved Application Launch Runtime", "approved_application_launch_runtime_ready"),
            ("Approved Project Tool Launch Runtime", "approved_project_tool_launch_runtime_ready"),
            ("Approved Browser Launch Runtime", "approved_browser_launch_runtime_ready"),
            ("Approved Editor Launch Runtime", "approved_editor_launch_runtime_ready"),
            ("Approved File Manager Launch Runtime", "approved_file_manager_launch_runtime_ready"),
            ...
            ("Application Launch Request Created", "application_launch_request_created"),
            ("Application Launch Preview Created", "application_launch_preview_packet_created"),
            ("Application Launch Approval Created", "application_launch_approval_handoff_created"),
            ("Application Launch Review Queue Item", "application_launch_review_queue_item_created"),
            ("Application Launch Action Executed", "application_launch_action_executed"),
            ("Application Allowlist Resolved", "application_allowlist_resolved"),
            ("Application Identity Validated", "application_identity_validated"),
            ("Application Process Spawned", "application_process_spawned"),
            ("Approved Application Launched", "approved_application_launched"),
            ("Approved Project Tool Launched", "approved_project_tool_launched"),
            ("Approved Browser Launched", "approved_browser_launched"),
            ("Approved Editor Launched", "approved_editor_launched"),
            ("Approved File Manager Launched", "approved_file_manager_launched"),
            ...
            ("No Application Launch Request Creation", "no_application_launch_request_creation"),
            ("No Application Launch Preview Creation", "no_application_launch_preview_creation"),
            ("No Application Launch Dispatch", "no_application_launch_dispatch"),
            ("No Application Process Spawn", "no_application_process_spawn"),
            ("No Approved Application Launch", "no_approved_application_launch"),
            ("No Approved Project Tool Launch", "no_approved_project_tool_launch"),
            ("No Approved Browser Launch", "no_approved_browser_launch"),
            ("No Approved Editor Launch", "no_approved_editor_launch"),
            ("No Approved File Manager Launch", "no_approved_file_manager_launch"),
            ("No Launch Without Preview", "no_launch_without_preview"),
            ("No Launch Without Approval", "no_launch_without_explicit_approval"),
            ("No Launch Non-Allowlisted App", "no_launch_non_allowlisted_application"),
            ("No Launch Arbitrary Executable", "no_launch_arbitrary_executable"),
    ...
    def active_permission_runtime_status(self) -> None:
        ...
        print("AURA Allowlisted Application Launch Status")
        print("==========================================")
        ...
        rows = [
            ...
            ("Planning Ready", "planning_ready"),
            ("Runtime Ready", "runtime_ready"),
            ("Contract Ready", "allowlisted_application_launch_contract_ready"),
            ("S216 App Launch Ready", "allowlisted_application_launch_contract_ready"),
            ("S216 App Launch Runtime", "allowlisted_application_launch_runtime_ready"),
            ("S216 App Launch Status", "allowlisted_application_launch_status"),
            ("Current Sprint", "permission_action_current_sprint"),
            ("Next Sprint", "permission_action_next_sprint"),
            ...
            ("Application Identity Before Launch", "application_identity_before_launch_required"),
            ("Safe Arguments Before Launch", "safe_arguments_before_launch_required"),
            ("Safe Environment Before Launch", "safe_environment_before_launch_required"),
            ("Single Application Launch Required", "single_application_launch_required"),
            ("Application Launch Request Schema", "application_launch_request_schema_ready"),
            ("Application Launch Target Schema", "application_launch_target_schema_ready"),
            ("Application Launch Preview Schema", "application_launch_preview_schema_ready"),
            ("Application Launch Allowlist Schema", "application_launch_allowlist_schema_ready"),
            ("Application Launch Permission Schema", "application_launch_permission_requirement_schema_ready"),
            ("Application Launch Audit Correlation Schema", "application_launch_audit_correlation_schema_ready"),
            ("Application Launch User Preview Schema", "application_launch_user_visible_preview_schema_ready"),
            ("Application Launch Approval Schema", "application_launch_approval_handoff_schema_ready"),
            ("Application Launch Review Queue Schema", "application_launch_review_queue_schema_ready"),
            ("Allowed App Launch Profile Count", "allowed_application_launch_profile_count"),
            ...
            ("Application Launch Runtime", "application_launch_runtime_ready"),
            ("Application Launch Request Creation", "application_launch_request_creation_allowed"),
            ("Application Launch Target Resolution", "application_launch_target_resolution_allowed"),
            ("Application Launch Preview Creation", "application_launch_preview_creation_allowed"),
            ("Application Launch Preview Render", "application_launch_preview_render_allowed"),
            ("Application Launch Approval Handoff", "application_launch_approval_handoff_allowed"),
            ("Application Launch Review Queue Enqueue", "application_launch_review_queue_enqueue_allowed"),
            ("Application Launch Dispatch", "application_launch_dispatch_allowed"),
            ("Application Allowlist Resolution", "application_allowlist_resolution_allowed"),
            ("Application Identity Validation", "application_identity_validation_allowed"),
            ("Application Executable Resolution", "application_executable_resolution_allowed"),
            ("Application Argument Resolution", "application_argument_resolution_allowed"),
            ("Application Environment Resolution", "application_environment_resolution_allowed"),
            ("Application Process Spawn", "application_process_spawn_allowed"),
            ("Approved Application Launch Runtime", "approved_application_launch_runtime_ready"),
            ("Approved Project Tool Launch Runtime", "approved_project_tool_launch_runtime_ready"),
            ("Approved Browser Launch Runtime", "approved_browser_launch_runtime_ready"),
            ("Approved Editor Launch Runtime", "approved_editor_launch_runtime_ready"),
            ("Approved File Manager Launch Runtime", "approved_file_manager_launch_runtime_ready"),
            ("Shell App Launch Dispatch", "shell_application_launch_dispatch_allowed"),
            ("OS App Launch Dispatch", "os_application_launch_dispatch_allowed"),
            ("Desktop App Launch Dispatch", "desktop_application_launch_dispatch_allowed"),
            ("Application Launch Allowed", "application_launch_allowed"),
            ("Desktop Action Allowed", "desktop_action_allowed"),
            ("File Mutation Allowed", "file_mutation_allowed"),
            ("Application Launch Request Created", "application_launch_request_created"),
            ...
            ("Application Allowlist Resolved", "application_allowlist_resolved"),
            ("Application Identity Validated", "application_identity_validated"),
            ("Application Executable Resolved", "application_executable_resolved"),
            ("Application Process Spawned", "application_process_spawned"),
            ("Approved Application Launched", "approved_application_launched"),
            ("Approved Project Tool Launched", "approved_project_tool_launched"),
            ("Approved Browser Launched", "approved_browser_launched"),
            ...
            ("No Launch Without Preview", "no_launch_without_preview"),
            ("No Launch Without Approval", "no_launch_without_explicit_approval"),
            ("No Launch Without Permission", "no_launch_without_permission"),
            ("No Launch Without Audit Correlation", "no_launch_without_audit_correlation"),
            ("No Launch Non-Allowlisted App", "no_launch_non_allowlisted_application"),
            ("No Launch Arbitrary Executable", "no_launch_arbitrary_executable"),
            ("No Launch Unapproved Arguments", "no_launch_with_unapproved_arguments"),
            ("No Launch Privileged Application", "no_launch_privileged_application"),
            ("No Launch Installer/Package Manager", "no_launch_installer_or_package_manager"),
            ("No Launch Multi-Step Chain", "no_launch_multi_step_chain"),
            ("No Application Launch", "no_application_launch"),
            ("No Desktop Action", "no_desktop_action"),
            ("No File Mutation", "no_file_mutation"),
            ("Safety Blocker Count", "safety_blocker_count"),
    ...
    def active_permission_runtime_check(self) -> None:
        ...
        planner = ActivePermissionRuntimePlanner()
        check = planner.check()
        contract = check.get("allowlisted_application_launch_contract", {})

        print("AURA Allowlisted Application Launch Check")
        print("=========================================")
        ...
        print()
        print("Sprint 216 Allowlisted Application Launch")
        print("-----------------------------------------")

        def row(label: str, key: str) -> None:
            print(f"{label:<47}: {contract.get(key)}")

        sprint_rows = [
            ("Contract Ready", "allowlisted_application_launch_contract_ready"),
            ("Runtime Ready", "allowlisted_application_launch_runtime_ready"),
            ("Runtime Status", "allowlisted_application_launch_status"),
            ("S216 App Launch Ready", "allowlisted_application_launch_contract_ready"),
            ("S216 App Launch Runtime", "allowlisted_application_launch_runtime_ready"),
            ("Current Sprint", "permission_action_current_sprint"),
            ("Next Sprint", "permission_action_next_sprint"),
        ...
        print()
        print("Allowlisted Application Launch Safety State")
        print("-------------------------------------------")

        safety_rows = [
            ("Application Launch Request Created", "application_launch_request_created"),
            ("Application Launch Target Created", "application_launch_target_packet_created"),
            ("Application Launch Preview Created", "application_launch_preview_packet_created"),
            ("Application Launch Allowlist Created", "application_launch_allowlist_packet_created"),
            ("Application Launch Audit Correlation Created", "application_launch_audit_correlation_created"),
            ("Application Launch User Preview Created", "application_launch_user_visible_preview_created"),
            ("Application Launch Approval Created", "application_launch_approval_handoff_created"),
            ("Application Launch Review Queue Item", "application_launch_review_queue_item_created"),
            ("Application Launch Action Created", "application_launch_action_created"),
            ("Application Launch Action Enqueued", "application_launch_action_enqueued"),
            ("Application Launch Action Executed", "application_launch_action_executed"),
            ("Application Allowlist Resolved", "application_allowlist_resolved"),
            ("Application Identity Validated", "application_identity_validated"),
            ("Application Executable Resolved", "application_executable_resolved"),
            ("Application Arguments Resolved", "application_arguments_resolved"),
            ("Application Environment Resolved", "application_environment_resolved"),
            ("Application Process Spawned", "application_process_spawned"),
            ("Approved Application Launched", "approved_application_launched"),
            ("Approved Project Tool Launched", "approved_project_tool_launched"),
            ("Approved Browser Launched", "approved_browser_launched"),
            ("Approved Editor Launched", "approved_editor_launched"),
            ("Approved File Manager Launched", "approved_file_manager_launched"),
            ("Shell App Launch Dispatched", "shell_application_launch_dispatched"),
            ("OS App Launch Dispatched", "os_application_launch_dispatched"),
            ("Desktop App Launch Dispatched", "desktop_application_launch_dispatched"),
            ("Action Executed", "action_executed"),
            ("Command Executed", "command_executed"),
            ("Tool Executed", "tool_executed"),
            ("File Mutated", "file_mutated"),
            ...
            ("Audit Event Written", "audit_event_written"),
            ("No Application Launch Request Creation", "no_application_launch_request_creation"),
            ("No Application Launch Target Resolution", "no_application_launch_target_resolution"),
            ("No Application Launch Preview Creation", "no_application_launch_preview_creation"),
            ("No Application Launch Preview Render", "no_application_launch_preview_render"),
            ("No Application Launch Approval Handoff", "no_application_launch_approval_handoff"),
            ("No Application Launch Review Queue Enqueue", "no_application_launch_review_queue_enqueue"),
            ("No Application Launch Dispatch", "no_application_launch_dispatch"),
            ("No Application Allowlist Resolution", "no_application_allowlist_resolution"),
            ("No Application Identity Validation", "no_application_identity_validation"),
            ("No Application Executable Resolution", "no_application_executable_resolution"),
            ("No Application Argument Resolution", "no_application_argument_resolution"),
            ("No Application Environment Resolution", "no_application_environment_resolution"),
            ("No Application Process Spawn", "no_application_process_spawn"),
            ("No Approved Application Launch", "no_approved_application_launch"),
            ("No Approved Project Tool Launch", "no_approved_project_tool_launch"),
            ("No Approved Browser Launch", "no_approved_browser_launch"),
            ("No Approved Editor Launch", "no_approved_editor_launch"),
            ("No Approved File Manager Launch", "no_approved_file_manager_launch"),
            ("No Shell App Launch Dispatch", "no_shell_application_launch_dispatch"),
            ("No OS App Launch Dispatch", "no_os_application_launch_dispatch"),
            ("No Desktop App Launch Dispatch", "no_desktop_application_launch_dispatch"),
            ("No Launch Without Preview", "no_launch_without_preview"),
            ("No Launch Without Approval", "no_launch_without_explicit_approval"),
            ("No Launch Without Permission", "no_launch_without_permission"),
            ("No Launch Without Audit Correlation", "no_launch_without_audit_correlation"),
            ...
            ("No Launch Privileged Application", "no_launch_privileged_application"),
            ("No Launch Installer/Package Manager", "no_launch_installer_or_package_manager"),
            ("No Launch Network Downloader", "no_launch_network_downloader"),
            ("No Launch Script Or Macro", "no_launch_script_or_macro"),
            ("No Launch Multi-Step Chain", "no_launch_multi_step_chain"),
            ("No Application Launch", "no_application_launch"),
            ("No Desktop Action", "no_desktop_action"),
            ("No File Mutation", "no_file_mutation"),
