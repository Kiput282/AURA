...
class AuraShell:
    ...
    def print_help(self) -> None:
        ...
        print("  partner-runtime-genesis-final-release-status Show Sprint 240 Genesis Final release status")
        print("  partner-runtime-genesis-final-release-context Show Sprint 240 Genesis Final release context")
        print("  partner-runtime-genesis-final-release-check Run Sprint 240 Genesis Final release checks")
        print("  partner-runtime-genesis-release-candidate-release-decision-status Show Sprint 239 Genesis release candidate release decision status")
        print("  partner-runtime-genesis-release-candidate-release-decision-context Show Sprint 239 Genesis release candidate release decision context")
        print("  partner-runtime-genesis-release-candidate-release-decision-check Run Sprint 239 Genesis release candidate release decision checks")
        print("  partner-runtime-genesis-release-candidate-release-gate-approval-status Show Sprint 238 Genesis release candidate release gate approval status")
        print("  partner-runtime-genesis-release-candidate-release-gate-approval-context Show Sprint 238 Genesis release candidate release gate approval context")
        print("  partner-runtime-genesis-release-candidate-release-gate-approval-check Run Sprint 238 Genesis release candidate release gate approval checks")
        print("  partner-runtime-genesis-release-candidate-release-gate-review-status Show Sprint 237 Genesis release candidate release gate review status")
        print("  partner-runtime-genesis-release-candidate-release-gate-review-context Show Sprint 237 Genesis release candidate release gate review context")
        print("  partner-runtime-genesis-release-candidate-release-gate-review-check Run Sprint 237 Genesis release candidate release gate review checks")
        print("  partner-runtime-genesis-release-candidate-release-authorization-status Show Sprint 236 Genesis release candidate release authorization status")
        print("  partner-runtime-genesis-release-candidate-release-authorization-context Show Sprint 236 Genesis release candidate release authorization context")
        print("  partner-runtime-genesis-release-candidate-release-authorization-check Run Sprint 236 Genesis release candidate release authorization checks")
    ...
    def handle_partner_runtime_shell_command(self, normalized: str) -> bool:
        # Sprint 240 Genesis Final Release shell commands.
        sprint_240_commands = {
        ...
        if normalized in sprint_240_commands:
            ...
            if normalized.endswith("-status"):
                title = "Genesis Final Release Status"
                packet = manager.status()
            elif normalized.endswith("-context"):
                title = "Genesis Final Release Context"
                packet = manager.context()
            else:
                title = "Genesis Final Release Check"
        ...
        # Sprint 239 Genesis Release Candidate Release Decision shell commands.
        sprint_239_commands = {
        ...
        if normalized in sprint_239_commands:
            from aura.partner_runtime import (
                GenesisReleaseCandidateReleaseDecisionAlphaManager,
            )

            manager = GenesisReleaseCandidateReleaseDecisionAlphaManager(
                project_root=self.project_root,
            )
        ...
        # Sprint 238 Genesis Release Candidate Release Gate Approval shell commands.
        sprint_238_commands = {
        ...
        if normalized in sprint_238_commands:
            from aura.partner_runtime import (
        ...
        # Sprint 237 Genesis Release Candidate Release Gate Review shell commands.
        sprint_237_commands = {
        ...
        if normalized in sprint_237_commands:
            from aura.partner_runtime import (
                GenesisReleaseCandidateReleaseGateReviewAlphaManager,
            )

            manager = GenesisReleaseCandidateReleaseGateReviewAlphaManager(
                project_root=self.project_root,
            )
            ...
            if normalized.endswith("-status"):
                title = (
                    "Genesis Release Candidate "
                    "Release Gate Review Status"
                )
                packet = manager.status()
            elif normalized.endswith("-context"):
                title = (
                    "Genesis Release Candidate "
                    "Release Gate Review Context"
                )
                packet = manager.context()
            else:
                title = (
                    "Genesis Release Candidate "
                    "Release Gate Review Check"
                )
                packet = manager.check()
        ...
        # Sprint 236 Genesis Release Candidate Release Authorization shell commands.
        sprint_236_commands = {
        ...
        if normalized in sprint_236_commands:
            from aura.partner_runtime import (
