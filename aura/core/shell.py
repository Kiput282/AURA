...
class AuraShell:
    ...
    def vision_runtime_check(self) -> None:
        ...
        print(f"Vision Block Start      : {screen_context['vision_runtime_block_start']}")
        print(f"Vision Block End        : {screen_context['vision_runtime_block_end']}")
        print(f"Current Sprint          : {screen_context['vision_runtime_current_sprint']}")
        print(f"Next Sprint             : {screen_context['vision_runtime_next_sprint']}")
        print(f"Next Boundary           : {screen_context['vision_runtime_next_boundary']}")
        print(f"Runtime Ready           : {screen_context['runtime_ready']}")
        print(f"Runtime Activation      : {screen_context['runtime_activation_allowed']}")
        print(f"Release Gate Open       : {screen_context['release_gate_open']}")
        print(f"Contract Only           : {screen_context['screen_context_adapter_contract_only']}")
        print(f"Provided Screenshot Context: {screen_context['provided_screenshot_context_required']}")
        print(f"Provided Screen Metadata  : {screen_context['provided_screen_metadata_required']}")
        print(f"Provided User Prompt      : {screen_context['provided_user_prompt_required']}")
        print(f"Provided Redaction Notes  : {screen_context['provided_redaction_notes_required']}")
        print(f"Placeholder Context Only  : {screen_context['placeholder_context_only']}")
        print(f"Contract Input Only       : {screen_context['contract_input_only']}")
        print(f"Image File Read Allowed   : {screen_context['image_file_read_allowed']}")
        print(f"Screenshot Required Now   : {screen_context['screenshot_capture_required_now']}")
        print(f"Screenshot File Read Now  : {screen_context['screenshot_file_read_required_now']}")
        print(f"Input Schema Ready        : {screen_context['screen_context_input_schema_ready']}")
        print(f"Metadata Schema Ready     : {screen_context['screen_context_metadata_schema_ready']}")
        print(f"Packet Schema Ready       : {screen_context['screen_context_packet_schema_ready']}")
        print(f"Summary Contract Ready    : {screen_context['screen_context_summary_contract_ready']}")
        print(f"Source Metadata Required  : {screen_context['screen_context_source_metadata_required']}")
        print(f"Uncertainty Required      : {screen_context['screen_context_uncertainty_required']}")
        print(f"No Visual Claims Without Model: {screen_context['screen_context_no_visual_claims_without_model']}")
        print(f"No OCR Claims Without OCR     : {screen_context['screen_context_no_ocr_claims_without_ocr']}")
        print(f"No Identity Claims            : {screen_context['screen_context_no_identity_claims']}")
        print(f"No Action Bypass              : {screen_context['screen_context_no_action_bypass']}")
        print(f"Permission Before Adapter     : {screen_context['permission_required_before_screen_context_adapter']}")
        print(f"Permission Before Handoff     : {screen_context['permission_required_before_context_handoff']}")
        print(f"Permission Before Chat Handoff: {screen_context['permission_required_before_chat_handoff']}")
        print(f"Redaction Before Adapter      : {screen_context['redaction_required_before_context_adapter']}")
        print(f"Redaction Before Packet       : {screen_context['redaction_required_before_context_packet']}")
        print(f"Redaction Before Chat Handoff : {screen_context['redaction_required_before_chat_handoff']}")
        print(f"Sensitive Region Redaction    : {screen_context['sensitive_region_redaction_required']}")
        print(f"Window Title Redaction        : {screen_context['window_title_redaction_required']}")
        print(f"URL Redaction                 : {screen_context['url_redaction_required']}")
        print(f"Clipboard Exclusion           : {screen_context['clipboard_exclusion_required']}")
        print(f"Safety Blocker Count          : {screen_context['safety_blocker_count']}")
        print(f"All Safety Blockers Off       : {screen_context['all_safety_blockers_inactive']}")
        print(f"Runtime Scope                 : {screen_context['runtime_scope']}")
        print()
        print("Screen Context Runtime Safety State")
        print("-----------------------------------")
        print(f"Screen Context Runtime Ready   : {screen_context['screen_context_runtime_ready']}")
        print(f"Screen Context Adapter Active  : {screen_context['screen_context_adapter_active']}")
        print(f"Screen Context Input Received  : {screen_context['screen_context_input_received']}")
        print(f"Screen Context Metadata Received: {screen_context['screen_context_metadata_received']}")
        print(f"Screen Context Packet Created  : {screen_context['screen_context_packet_created']}")
        print(f"Screen Context Summary Created : {screen_context['screen_context_summary_created']}")
        print(f"Screen Context Handoff Active  : {screen_context['screen_context_handoff_active']}")
        print(f"Screen Context Chat Handoff    : {screen_context['screen_context_to_chat_handoff_active']}")
        print(f"Screenshot Context Handoff     : {screen_context['screenshot_to_context_handoff_active']}")
        print(f"Screenshot Capture Performed   : {screen_context['screenshot_capture_performed']}")
        print(f"Screenshot Output Created      : {screen_context['screenshot_output_file_created']}")
        print(f"Screenshot File Write          : {screen_context['screenshot_file_write_active']}")
        print(f"Screenshot File Read           : {screen_context['screenshot_file_read_active']}")
        print(f"Screenshot Storage Persist     : {screen_context['screenshot_storage_persistence_enabled']}")
        print(f"Screenshot Metadata Persist    : {screen_context['screenshot_metadata_persistence_enabled']}")
        print(f"Redaction Runtime              : {screen_context['redaction_runtime_active']}")
        print(f"Redacted Context Created       : {screen_context['redacted_context_created']}")
        print(f"Context Persistence            : {screen_context['context_persistence_enabled']}")
        print(f"Metadata Persistence           : {screen_context['metadata_persistence_enabled']}")
        print(f"Screen Context Memory Write    : {screen_context['screen_context_memory_write_enabled']}")
        print(f"Vision Model Runtime           : {screen_context['vision_model_runtime_active']}")
        print(f"OCR Runtime Active             : {screen_context['ocr_runtime_active']}")
        print(f"Image Analysis Runtime         : {screen_context['image_analysis_runtime_active']}")
        print(f"Object Detection Runtime       : {screen_context['object_detection_runtime_active']}")
        print(f"Visual Action Execution        : {screen_context['visual_action_execution_active']}")
        print(f"Visual Tool Execution          : {screen_context['visual_tool_execution_active']}")
        print(f"Command Execution              : {screen_context['command_execution_active']}")
        print(f"File Mutation                  : {screen_context['file_mutation_active']}")
        print(f"Desktop Action                 : {screen_context['desktop_action_active']}")
        print(f"Network Action                 : {screen_context['network_action_active']}")
        print(f"Git Action                     : {screen_context['git_action_active']}")
        print(f"Memory Write                   : {screen_context['memory_write_active']}")
        print(f"Cloud Vision Fallback          : {screen_context['cloud_vision_fallback_enabled']}")
        print(f"External Upload                : {screen_context['external_upload_enabled']}")
        print(f"Dependency Install             : {screen_context['dependency_install_performed']}")
        print(f"Model Download                 : {screen_context['model_download_performed']}")
        print()
