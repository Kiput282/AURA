...
class AuraShell:
    ...
    def vision_runtime_check(self) -> None:
        ...
        print(f"Vision Block Start      : {local_model['vision_runtime_block_start']}")
        print(f"Vision Block End        : {local_model['vision_runtime_block_end']}")
        print(f"Current Sprint          : {local_model['vision_runtime_current_sprint']}")
        print(f"Next Sprint             : {local_model['vision_runtime_next_sprint']}")
        print(f"Next Boundary           : {local_model['vision_runtime_next_boundary']}")
        print(f"Runtime Ready           : {local_model['runtime_ready']}")
        print(f"Runtime Activation      : {local_model['runtime_activation_allowed']}")
        print(f"Release Gate Open       : {local_model['release_gate_open']}")
        print(f"Contract Only           : {local_model['local_vision_model_adapter_contract_only']}")
        print(f"Local First Required    : {local_model['local_first_required']}")
        print(f"Offline First Required  : {local_model['offline_first_required']}")
        print(f"Local Provider Required : {local_model['local_provider_required']}")
        print(f"Local Provider Contract : {local_model['local_provider_contract_ready']}")
        print(f"Supported Provider Count: {local_model['supported_local_provider_count']}")
        print(f"Model Candidate Count   : {local_model['local_vision_model_candidate_count']}")
        print(f"Model Candidates Ready  : {local_model['local_vision_model_candidates_ready']}")
        print(f"Default Model Candidate : {local_model['local_vision_model_default_candidate']}")
        print(f"Adapter Selection Schema: {local_model['adapter_selection_schema_ready']}")
        print(f"Model Request Schema    : {local_model['model_request_schema_ready']}")
        print(f"Model Response Schema   : {local_model['model_response_schema_ready']}")
        print(f"Model Capability Schema : {local_model['model_capability_schema_ready']}")
        print(f"Visual Prompt Contract  : {local_model['visual_prompt_contract_ready']}")
        print(f"Provided Screen Context : {local_model['provided_screen_context_required']}")
        print(f"Provided Screen Metadata: {local_model['provided_screen_metadata_required']}")
        print(f"Provided User Prompt    : {local_model['provided_user_prompt_required']}")
        print(f"Redacted Context Required: {local_model['redacted_context_required']}")
        print(f"Source Metadata Required : {local_model['source_metadata_required']}")
        print(f"Uncertainty Required     : {local_model['uncertainty_required']}")
        print(f"Permission Before Adapter: {local_model['permission_required_before_model_adapter']}")
        print(f"Permission Before Probe  : {local_model['permission_required_before_model_probe']}")
        print(f"Permission Before Request: {local_model['permission_required_before_model_request']}")
        print(f"Permission Before Execution: {local_model['permission_required_before_model_execution']}")
        print(f"Redaction Before Request : {local_model['redaction_required_before_model_request']}")
        print(f"Redaction Before Response: {local_model['redaction_required_before_model_response']}")
        print(f"No Raw Screenshot To Model: {local_model['no_raw_screenshot_to_model']}")
        print(f"No Unredacted Context To Model: {local_model['no_unredacted_context_to_model']}")
        print(f"Image File Read Allowed  : {local_model['image_file_read_allowed']}")
        print(f"Screenshot Required Now  : {local_model['screenshot_capture_required_now']}")
        print(f"Screenshot File Read Now : {local_model['screenshot_file_read_required_now']}")
        print(f"OCR Required Now         : {local_model['ocr_required_now']}")
        print(f"Cloud Vision Fallback Allowed: {local_model['cloud_vision_fallback_allowed']}")
        print(f"External Upload Allowed  : {local_model['external_upload_allowed']}")
        print(f"Model Download Required Now: {local_model['model_download_required_now']}")
        print(f"Model Download Performed : {local_model['model_download_performed']}")
        print(f"Dependency Install       : {local_model['dependency_install_performed']}")
        print(f"Safety Blocker Count     : {local_model['safety_blocker_count']}")
        print(f"All Safety Blockers Off  : {local_model['all_safety_blockers_inactive']}")
        print(f"Runtime Scope            : {local_model['runtime_scope']}")
        print()
        print("Local Vision Model Runtime Safety State")
        print("---------------------------------------")
        print(f"Local Vision Adapter Active: {local_model['local_vision_model_adapter_active']}")
        print(f"Local Provider Probe Active: {local_model['local_model_provider_probe_active']}")
        ...
        print(f"Local Model Response Created: {local_model['local_model_response_created']}")
        print(f"Local Model Response Persistence: {local_model['local_model_response_persistence_enabled']}")
        print(f"Visual Description Created : {local_model['visual_description_created']}")
        print(f"Visual Classification Created: {local_model['visual_classification_created']}")
        print(f"Visual Reasoning Created   : {local_model['visual_reasoning_created']}")
        print(f"Screen Context To Model Handoff: {local_model['screen_context_to_model_handoff_active']}")
        print(f"Model To Chat Handoff      : {local_model['model_to_chat_handoff_active']}")
        print(f"Screenshot Capture Performed: {local_model['screenshot_capture_performed']}")
        print(f"Screenshot Output Created  : {local_model['screenshot_output_file_created']}")
        print(f"Screenshot File Write      : {local_model['screenshot_file_write_active']}")
        print(f"Screenshot File Read       : {local_model['screenshot_file_read_active']}")
        print(f"Screen Context Packet Created: {local_model['screen_context_packet_created']}")
        print(f"Screen Context Handoff     : {local_model['screen_context_handoff_active']}")
        print(f"Redaction Runtime          : {local_model['redaction_runtime_active']}")
        print(f"Redacted Context Created   : {local_model['redacted_context_created']}")
        print(f"Vision Model Runtime       : {local_model['vision_model_runtime_active']}")
        print(f"OCR Runtime Active         : {local_model['ocr_runtime_active']}")
        print(f"Image Analysis Runtime     : {local_model['image_analysis_runtime_active']}")
        print(f"Object Detection Runtime   : {local_model['object_detection_runtime_active']}")
        print(f"Visual Action Execution    : {local_model['visual_action_execution_active']}")
        print(f"Visual Tool Execution      : {local_model['visual_tool_execution_active']}")
        print(f"Command Execution          : {local_model['command_execution_active']}")
        print(f"File Mutation              : {local_model['file_mutation_active']}")
        print(f"Desktop Action             : {local_model['desktop_action_active']}")
        print(f"Network Action             : {local_model['network_action_active']}")
        print(f"Git Action                 : {local_model['git_action_active']}")
        print(f"Memory Write               : {local_model['memory_write_active']}")
        print(f"Cloud Vision Fallback      : {local_model['cloud_vision_fallback_enabled']}")
        print(f"External Upload            : {local_model['external_upload_enabled']}")
        print(f"Visual Context Action Bypass: {local_model['visual_context_to_action_bypass_enabled']}")
        print(f"No Tool Use From Model     : {local_model['no_tool_use_from_model']}")
        print(f"No Autonomous Action       : {local_model['no_autonomous_action']}")
        print(f"No Identity Claims         : {local_model['no_identity_claims']}")
        print(f"No Biometric Identification: {local_model['no_biometric_identification']}")
        print(f"No Emotion Inference From Face: {local_model['no_emotion_inference_from_face']}")
        print()
