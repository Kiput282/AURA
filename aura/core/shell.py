...
class AuraShell:
    ...
    def vision_runtime_check(self) -> None:
        ...
        print(f"Vision Block Start     : {screenshot['vision_runtime_block_start']}")
        print(f"Vision Block End       : {screenshot['vision_runtime_block_end']}")
        print(f"Current Sprint         : {screenshot['vision_runtime_current_sprint']}")
        print(f"Next Sprint            : {screenshot['vision_runtime_next_sprint']}")
        print(f"Next Boundary          : {screenshot['vision_runtime_next_boundary']}")
        print(f"Runtime Ready          : {screenshot['runtime_ready']}")
        print(f"Runtime Activation     : {screenshot['runtime_activation_allowed']}")
        print(f"Release Gate Open      : {screenshot['release_gate_open']}")
        print(f"Explicit Request       : {screenshot['explicit_screenshot_request_required']}")
        print(f"Explicit Confirmation  : {screenshot['explicit_screenshot_confirmation_required']}")
        print(f"Permission Required    : {screenshot['explicit_screenshot_permission_required']}")
        print(f"Permission Before Screenshot: {screenshot['permission_required_before_screenshot']}")
        print(f"Permission Before Screen    : {screenshot['permission_required_before_screen']}")
        print(f"Permission Before File Write: {screenshot['permission_required_before_image_file_write']}")
        print(f"Permission Before Handoff   : {screenshot['permission_required_before_context_handoff']}")
        print(f"Redaction Before Handoff    : {screenshot['redaction_required_before_context_handoff']}")
        print(f"Single Capture Only    : {screenshot['single_capture_only']}")
        print(f"Continuous Capture     : {screenshot['continuous_capture_allowed']}")
        print(f"Background Capture     : {screenshot['background_capture_allowed']}")
        print(f"Silent Capture         : {screenshot['silent_capture_allowed']}")
        print(f"Automatic Capture      : {screenshot['automatic_capture_allowed']}")
        print(f"Scheduled Capture      : {screenshot['scheduled_capture_allowed']}")
        print(f"Screen Permission      : {screenshot['screen_permission_action']}")
        print(f"Screenshot Candidates  : {screenshot['screenshot_candidate_count']}")
        print(f"Screenshot Candidates Ready: {screenshot['screenshot_candidates_ready']}")
        print(f"Safety Blocker Count   : {screenshot['safety_blocker_count']}")
        print(f"All Safety Blockers Off: {screenshot['all_safety_blockers_inactive']}")
        print(f"Runtime Scope          : {screenshot['runtime_scope']}")
        print()
        print("Screenshot Runtime Safety State")
        print("-------------------------------")
        print(f"Screen Capture Runtime Ready: {screenshot['screen_capture_runtime_ready']}")
        print(f"Screenshot Runtime Ready    : {screenshot['screenshot_capture_runtime_ready']}")
        print(f"Screenshot Request Active   : {screenshot['screenshot_request_active']}")
        print(f"Screenshot Permission Active: {screenshot['screenshot_permission_request_active']}")
        print(f"Screenshot Confirm Active   : {screenshot['screenshot_confirmation_active']}")
        print(f"Screenshot Capture Allowed  : {screenshot['screenshot_capture_allowed']}")
        print(f"Screenshot Capture Active   : {screenshot['screenshot_capture_active']}")
        print(f"Screenshot Capture Performed: {screenshot['screenshot_capture_performed']}")
        print(f"Screenshot Output Created   : {screenshot['screenshot_output_file_created']}")
        print(f"Screenshot File Write       : {screenshot['screenshot_file_write_active']}")
        print(f"Screenshot File Read        : {screenshot['screenshot_file_read_active']}")
        print(f"Screenshot Storage Persist  : {screenshot['screenshot_storage_persistence_enabled']}")
        print(f"Screenshot Metadata Persist : {screenshot['screenshot_metadata_persistence_enabled']}")
        print(f"Screenshot Context Handoff  : {screenshot['screenshot_to_context_handoff_active']}")
        print(f"Screen Context Adapter      : {screenshot['screen_context_adapter_active']}")
        print(f"Redaction Runtime           : {screenshot['redaction_runtime_active']}")
        print(f"Vision Model Runtime        : {screenshot['vision_model_runtime_active']}")
        print(f"OCR Runtime Active          : {screenshot['ocr_runtime_active']}")
        print(f"Image Analysis Runtime      : {screenshot['image_analysis_runtime_active']}")
        print(f"Object Detection Runtime    : {screenshot['object_detection_runtime_active']}")
        print(f"Visual Action Execution     : {screenshot['visual_action_execution_active']}")
        print(f"Visual Tool Execution       : {screenshot['visual_tool_execution_active']}")
        print(f"Command Execution           : {screenshot['command_execution_active']}")
        print(f"File Mutation               : {screenshot['file_mutation_active']}")
        print(f"Desktop Action              : {screenshot['desktop_action_active']}")
        print(f"Network Action              : {screenshot['network_action_active']}")
        print(f"Git Action                  : {screenshot['git_action_active']}")
        print(f"Memory Write                : {screenshot['memory_write_active']}")
        print(f"Cloud Vision Fallback       : {screenshot['cloud_vision_fallback_enabled']}")
        print(f"External Upload             : {screenshot['external_upload_enabled']}")
        print(f"Dependency Install          : {screenshot['dependency_install_performed']}")
        print(f"Model Download              : {screenshot['model_download_performed']}")
        print()
