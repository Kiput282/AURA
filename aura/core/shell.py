...
class AuraShell:
    ...
    def vision_runtime_check(self) -> None:
        ...
        print(f"Vision Block Start     : {activation['vision_runtime_block_start']}")
        print(f"Vision Block End       : {activation['vision_runtime_block_end']}")
        print(f"Current Sprint         : {activation['vision_runtime_current_sprint']}")
        print(f"Next Sprint            : {activation['vision_runtime_next_sprint']}")
        print(f"Next Boundary          : {activation['vision_runtime_next_boundary']}")
        print(f"Runtime Ready          : {activation['runtime_ready']}")
        print(f"Runtime Activation     : {activation['runtime_activation_allowed']}")
        print(f"Release Gate Open      : {activation['release_gate_open']}")
        print(f"Safe Idle Default      : {activation['safe_idle_default']}")
        print(f"Local First Required   : {activation['local_first_required']}")
        print(f"Offline First Preferred: {activation['offline_first_preferred']}")
        print(f"Explicit Visual Input  : {activation['explicit_visual_input_required']}")
        print(f"Explicit Confirmation  : {activation['explicit_user_confirmation_required']}")
        print(f"Permission Before Screen: {activation['permission_required_before_screen']}")
        print(f"Permission Before Camera: {activation['permission_required_before_camera']}")
        print(f"Permission Before Analysis: {activation['permission_required_before_image_analysis']}")
        print(f"Permission Before Action  : {activation['permission_required_before_visual_action']}")
        print(f"User Image First      : {activation['user_provided_image_first']}")
        print(f"Screen Permission     : {activation['screen_permission_action']}")
        print(f"Camera Permission     : {activation['camera_permission_action']}")
        print(f"Screen Candidates     : {activation['screen_capture_candidate_count']}")
        print(f"Camera Candidates     : {activation['camera_capture_candidate_count']}")
        print(f"Vision Model Candidates: {activation['vision_model_candidate_count']}")
        print(f"Safety Blocker Count  : {activation['safety_blocker_count']}")
        print(f"All Safety Blockers Off: {activation['all_safety_blockers_inactive']}")
        print(f"Runtime Scope         : {activation['runtime_scope']}")
        print()
        print("Vision Runtime Safety State")
        print("---------------------------")
        print(f"Screen Access              : {activation['screen_access']}")
        print(f"Camera Access              : {activation['camera_access']}")
        print(f"Screen Capture Active      : {activation['screen_capture_active']}")
        print(f"Screenshot Capture Active  : {activation['screenshot_capture_active']}")
        print(f"Camera Frame Capture Active: {activation['camera_frame_capture_active']}")
        print(f"Image Capture Active       : {activation['image_capture_active']}")
        print(f"Video Capture Active       : {activation['video_capture_active']}")
        print(f"Webcam Runtime Active      : {activation['webcam_runtime_active']}")
        print(f"Vision Runtime Active      : {activation['vision_runtime_active']}")
        print(f"Visual Context Runtime     : {activation['visual_context_runtime_active']}")
        print(f"Image Analysis Runtime     : {activation['image_analysis_runtime_active']}")
        print(f"Object Detection Runtime   : {activation['object_detection_runtime_active']}")
        print(f"OCR Runtime Active         : {activation['ocr_runtime_active']}")
        print(f"Image Text Extraction      : {activation['image_text_extraction_runtime_active']}")
        print(f"Continuous Watch Active    : {activation['continuous_watch_active']}")
        print(f"Background Watch Active    : {activation['background_watch_active']}")
        print(f"Silent Capture Enabled     : {activation['silent_capture_enabled']}")
        print(f"Camera Default Activation  : {activation['camera_activation_by_default_enabled']}")
        print(f"Biometric Identification   : {activation['biometric_identification_enabled']}")
        print(f"Face Recognition           : {activation['face_recognition_enabled']}")
        print(f"Identity Recognition       : {activation['identity_recognition_enabled']}")
        print(f"Face Emotion Inference     : {activation['emotion_inference_from_face_enabled']}")
        print(f"Visual Action Bypass       : {activation['visual_context_to_action_bypass_enabled']}")
        print(f"Visual Action Execution    : {activation['visual_action_execution_active']}")
        print(f"Visual Tool Execution      : {activation['visual_tool_execution_active']}")
        print(f"Command Execution          : {activation['command_execution_active']}")
        print(f"File Mutation              : {activation['file_mutation_active']}")
        print(f"Desktop Action             : {activation['desktop_action_active']}")
        print(f"Network Action             : {activation['network_action_active']}")
        print(f"Git Action                 : {activation['git_action_active']}")
        print(f"Memory Write               : {activation['memory_write_active']}")
        print(f"Cloud Vision Fallback      : {activation['cloud_vision_fallback_enabled']}")
        print(f"External Upload            : {activation['external_upload_enabled']}")
        print(f"Dependency Install         : {activation['dependency_install_performed']}")
        print(f"Model Download             : {activation['model_download_performed']}")
        print(f"Screen Capture Performed   : {activation['screen_capture_performed']}")
        print(f"Camera Frame Performed     : {activation['camera_frame_capture_performed']}")
        print(f"Image File Read Performed  : {activation['image_file_read_performed']}")
        print(f"OCR Performed              : {activation['ocr_performed']}")
        print(f"Visual Recognition Done    : {activation['visual_recognition_performed']}")
        print(f"Visual Action Performed    : {activation['visual_action_performed']}")
        print()
        print("Vision Safety Blockers")
        print("----------------------")
        for blocker in activation["safety_blockers"]:
            print(f"- {blocker}")
        print()
