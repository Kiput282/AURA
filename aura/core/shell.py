...
class AuraShell:
    ...
    def active_permission_runtime_alpha_status(self) -> None:
        ...
        print("AURA Controlled Folder and Simple File Creation Alpha")
        print("=====================================================")
        ...
        rows = [
            ...
            ("Alpha Ready", "planning_ready"),
            ("S216 App Launch Ready", "sprint_216_allowlisted_application_launch_contract_ready"),
            ("S217 Creation Ready", "sprint_217_controlled_folder_simple_file_creation_contract_ready"),
            ("S217 Creation Runtime", "controlled_folder_simple_file_creation_runtime_ready"),
            ("S217 Creation Status", "controlled_folder_simple_file_creation_status"),
            ...
            ("Preview Before Create Required", "preview_before_create_required"),
            ("Explicit Approval Before Create", "explicit_approval_before_create_required"),
            ("Permission Before Create Required", "permission_before_create_required"),
            ("Audit Correlation Before Create", "audit_correlation_before_create_required"),
            ("Allowlist Before Create Required", "allowlist_before_create_required"),
            ("Canonical Path Before Create", "canonical_path_before_create_required"),
            ("Parent Path Before Create", "parent_path_before_create_required"),
            ("Safe Content Before File Create", "safe_content_before_file_create_required"),
            ("Controlled Creation Request Schema", "controlled_creation_request_schema_ready"),
            ("Controlled Creation Target Schema", "controlled_creation_target_schema_ready"),
            ("Controlled Creation Preview Schema", "controlled_creation_preview_schema_ready"),
            ("Controlled Creation Path Policy Schema", "controlled_creation_path_policy_schema_ready"),
            ("Controlled Creation Allowlist Schema", "controlled_creation_allowlist_schema_ready"),
            ("Controlled Creation User Preview Schema", "controlled_creation_user_visible_preview_schema_ready"),
            ("Controlled Creation Approval Schema", "controlled_creation_approval_handoff_schema_ready"),
            ("Controlled Creation Review Queue Schema", "controlled_creation_review_queue_schema_ready"),
            ("Folder Creation Request Schema", "folder_creation_request_schema_ready"),
            ("Simple File Creation Request Schema", "simple_file_creation_request_schema_ready"),
            ("Simple File Content Preview Schema", "simple_file_creation_content_preview_schema_ready"),
            ("Allowed Creation Profile Count", "allowed_controlled_creation_profile_count"),
            ("Blocked Creation Target Count", "blocked_controlled_creation_target_count"),
            ("Controlled Creation Runtime", "controlled_creation_runtime_ready"),
            ("Controlled Creation Request Creation", "controlled_creation_request_creation_allowed"),
            ("Controlled Creation Preview Creation", "controlled_creation_preview_creation_allowed"),
            ("Controlled Creation Dispatch", "controlled_creation_dispatch_allowed"),
            ("Folder Creation Runtime", "folder_creation_runtime_ready"),
            ("Simple File Creation Runtime", "simple_file_creation_runtime_ready"),
            ("File Write Runtime", "file_write_runtime_ready"),
            ("Folder Mkdir Runtime", "folder_mkdir_runtime_ready"),
            ("Filesystem Mutation Runtime", "filesystem_mutation_runtime_ready"),
            ...
            ("Controlled Creation Request Created", "controlled_creation_request_created"),
            ("Controlled Creation Preview Created", "controlled_creation_preview_packet_created"),
            ("Controlled Creation Approval Created", "controlled_creation_approval_handoff_created"),
            ("Controlled Creation Review Queue Item", "controlled_creation_review_queue_item_created"),
            ("Controlled Creation Action Executed", "controlled_creation_action_executed"),
            ("Folder Creation Request Created", "folder_creation_request_created"),
            ("Simple File Creation Request Created", "simple_file_creation_request_created"),
            ("Folder Created", "folder_created"),
            ("Project Folder Created", "project_folder_created"),
            ("Simple File Created", "simple_file_created"),
            ("Project Simple File Created", "project_simple_file_created"),
            ("File Written", "file_written"),
            ("Folder Mkdir Performed", "folder_mkdir_performed"),
            ("Filesystem Mutated", "filesystem_mutated"),
            ...
            ("No Controlled Creation Request", "no_controlled_creation_request_creation"),
            ("No Controlled Creation Preview", "no_controlled_creation_preview_creation"),
            ("No Controlled Creation Dispatch", "no_controlled_creation_dispatch"),
            ("No Folder Creation Runtime", "no_folder_creation_runtime"),
            ("No Simple File Creation Runtime", "no_simple_file_creation_runtime"),
            ("No File Write", "no_file_write"),
            ("No Folder Mkdir", "no_folder_mkdir"),
            ("No Filesystem Mutation", "no_filesystem_mutation"),
            ("No Create Without Preview", "no_create_without_preview"),
            ("No Create Without Approval", "no_create_without_explicit_approval"),
            ("No Create Arbitrary Path", "no_create_arbitrary_path"),
            ("No Overwrite Existing Path", "no_overwrite_existing_path"),
            ("No Recursive Bulk Creation", "no_recursive_bulk_creation"),
    ...
    def active_permission_runtime_status(self) -> None:
        ...
        print("AURA Controlled Folder and Simple File Creation Status")
        print("======================================================")

        def row(label: str, key: str, fallback: object = "n/a") -> None:
            print(f"{label:<50}: {status.get(key, fallback)}")
        ...
        rows = [
            ...
            ("Planning Ready", "planning_ready"),
            ("Runtime Ready", "runtime_ready"),
            ("Contract Ready", "controlled_folder_simple_file_creation_contract_ready"),
            ("S217 Creation Ready", "controlled_folder_simple_file_creation_contract_ready"),
            ("S217 Creation Runtime", "controlled_folder_simple_file_creation_runtime_ready"),
            ("S217 Creation Status", "controlled_folder_simple_file_creation_status"),
            ("Current Sprint", "permission_action_current_sprint"),
            ("Next Sprint", "permission_action_next_sprint"),
            ...
            ("Parent Path Before Create", "parent_path_before_create_required"),
            ("Safe Content Before File Create", "safe_content_before_file_create_required"),
            ("Single Creation Action Required", "single_creation_action_required"),
            ("Controlled Creation Request Schema", "controlled_creation_request_schema_ready"),
            ("Controlled Creation Target Schema", "controlled_creation_target_schema_ready"),
            ("Controlled Creation Preview Schema", "controlled_creation_preview_schema_ready"),
            ("Controlled Creation Path Policy Schema", "controlled_creation_path_policy_schema_ready"),
            ("Controlled Creation Allowlist Schema", "controlled_creation_allowlist_schema_ready"),
            ("Controlled Creation Permission Schema", "controlled_creation_permission_requirement_schema_ready"),
            ("Controlled Creation Audit Correlation Schema", "controlled_creation_audit_correlation_schema_ready"),
            ("Controlled Creation User Preview Schema", "controlled_creation_user_visible_preview_schema_ready"),
            ("Controlled Creation Approval Schema", "controlled_creation_approval_handoff_schema_ready"),
            ("Controlled Creation Review Queue Schema", "controlled_creation_review_queue_schema_ready"),
            ("Folder Creation Request Schema", "folder_creation_request_schema_ready"),
            ("Folder Creation Target Schema", "folder_creation_target_schema_ready"),
            ("Folder Creation Preview Schema", "folder_creation_preview_schema_ready"),
            ("Simple File Creation Request Schema", "simple_file_creation_request_schema_ready"),
            ("Simple File Creation Target Schema", "simple_file_creation_target_schema_ready"),
            ("Simple File Content Preview Schema", "simple_file_creation_content_preview_schema_ready"),
            ("Allowed Creation Profile Count", "allowed_controlled_creation_profile_count"),
            ("Blocked Creation Target Count", "blocked_controlled_creation_target_count"),
            ("Controlled Creation Runtime", "controlled_creation_runtime_ready"),
            ...
            ("Folder Creation Runtime", "folder_creation_runtime_ready"),
            ("Simple File Creation Runtime", "simple_file_creation_runtime_ready"),
            ("Project Folder Creation Runtime", "project_folder_creation_runtime_ready"),
            ("Project Simple File Creation Runtime", "project_simple_file_creation_runtime_ready"),
            ("Parent Path Allowlist Resolution", "parent_path_allowlist_resolution_allowed"),
            ("Target Path Canonicalization", "target_path_canonicalization_allowed"),
            ("Target Path Access", "target_path_access_allowed"),
            ("Directory Listing Runtime", "directory_listing_runtime_ready"),
            ("File Read Runtime", "file_read_runtime_ready"),
            ("File Write Runtime", "file_write_runtime_ready"),
            ("Folder Mkdir Runtime", "folder_mkdir_runtime_ready"),
            ("Filesystem Mutation Runtime", "filesystem_mutation_runtime_ready"),
            ("File Mutation Allowed", "file_mutation_allowed"),
            ...
            ("Folder Creation Request Created", "folder_creation_request_created"),
            ("Simple File Creation Request Created", "simple_file_creation_request_created"),
            ("Parent Path Allowlist Resolved", "parent_path_allowlist_resolved"),
            ("Target Path Canonicalized", "target_path_canonicalized"),
            ("Target Path Accessed", "target_path_accessed"),
            ("Directory Listing Performed", "directory_listing_performed"),
            ("File Read Performed", "file_read_performed"),
            ("Folder Created", "folder_created"),
            ("Project Folder Created", "project_folder_created"),
            ("Simple File Created", "simple_file_created"),
            ("Project Simple File Created", "project_simple_file_created"),
            ...
            ("No Folder Creation Runtime", "no_folder_creation_runtime"),
            ("No Simple File Creation Runtime", "no_simple_file_creation_runtime"),
            ("No Parent Path Allowlist Resolution", "no_parent_path_allowlist_resolution"),
            ("No Target Path Canonicalization", "no_target_path_canonicalization"),
            ("No Target Path Access", "no_target_path_access"),
            ("No Directory Listing", "no_directory_listing"),
            ("No File Read", "no_file_read"),
            ("No File Write", "no_file_write"),
            ("No Folder Mkdir", "no_folder_mkdir"),
            ("No Filesystem Mutation", "no_filesystem_mutation"),
            ("No Create Without Preview", "no_create_without_preview"),
            ("No Create Without Approval", "no_create_without_explicit_approval"),
            ("No Create Without Permission", "no_create_without_permission"),
            ("No Create Arbitrary Path", "no_create_arbitrary_path"),
            ("No Overwrite Existing Path", "no_overwrite_existing_path"),
            ("No Recursive Bulk Creation", "no_recursive_bulk_creation"),
            ("No File Mutation", "no_file_mutation"),
    ...
    def active_permission_runtime_check(self) -> None:
        ...
        planner = ActivePermissionRuntimePlanner()
        check = planner.check()
        contract = check.get("controlled_folder_simple_file_creation_contract", {})

        print("AURA Controlled Folder and Simple File Creation Check")
        print("=====================================================")
        ...
        print()
        print("Sprint 217 Controlled Folder and Simple File Creation")
        print("-----------------------------------------------------")

        def row(label: str, key: str) -> None:
            print(f"{label:<51}: {contract.get(key)}")

        sprint_rows = [
            ("Contract Ready", "controlled_folder_simple_file_creation_contract_ready"),
            ("Runtime Ready", "controlled_folder_simple_file_creation_runtime_ready"),
            ("Runtime Status", "controlled_folder_simple_file_creation_status"),
            ("S217 Creation Ready", "controlled_folder_simple_file_creation_contract_ready"),
            ("S217 Creation Runtime", "controlled_folder_simple_file_creation_runtime_ready"),
            ("Current Sprint", "permission_action_current_sprint"),
            ("Next Sprint", "permission_action_next_sprint"),
            ...
            ("Controlled Creation Runtime", "controlled_creation_runtime_ready"),
            ("Controlled Creation Request Creation", "controlled_creation_request_creation_allowed"),
            ("Controlled Creation Target Resolution", "controlled_creation_target_resolution_allowed"),
            ("Controlled Creation Preview Creation", "controlled_creation_preview_creation_allowed"),
            ("Controlled Creation Preview Render", "controlled_creation_preview_render_allowed"),
            ("Controlled Creation Approval Handoff", "controlled_creation_approval_handoff_allowed"),
            ("Controlled Creation Review Queue Enqueue", "controlled_creation_review_queue_enqueue_allowed"),
            ("Controlled Creation Dispatch", "controlled_creation_dispatch_allowed"),
            ("Folder Creation Runtime", "folder_creation_runtime_ready"),
            ("Simple File Creation Runtime", "simple_file_creation_runtime_ready"),
            ("Project Folder Creation Runtime", "project_folder_creation_runtime_ready"),
            ...
            ("Folder Mkdir Runtime", "folder_mkdir_runtime_ready"),
            ("Filesystem Mutation Runtime", "filesystem_mutation_runtime_ready"),
            ("Shell File Creation Dispatch", "shell_file_creation_dispatch_allowed"),
            ("OS File Creation Dispatch", "os_file_creation_dispatch_allowed"),
            ("Tool File Creation Dispatch", "tool_file_creation_dispatch_allowed"),
            ("File Mutation Allowed", "file_mutation_allowed"),
            ("Desktop Action Allowed", "desktop_action_allowed"),
            ("Application Launch Allowed", "application_launch_allowed"),
        ]
        ...
        print()
        print("Controlled Folder and Simple File Creation Safety State")
        print("-------------------------------------------------------")

        safety_rows = [
            ("Controlled Creation Request Created", "controlled_creation_request_created"),
            ("Controlled Creation Target Created", "controlled_creation_target_packet_created"),
            ("Controlled Creation Preview Created", "controlled_creation_preview_packet_created"),
            ("Controlled Creation Path Policy Created", "controlled_creation_path_policy_created"),
            ("Controlled Creation Allowlist Created", "controlled_creation_allowlist_packet_created"),
            ("Controlled Creation Audit Correlation Created", "controlled_creation_audit_correlation_created"),
            ("Controlled Creation User Preview Created", "controlled_creation_user_visible_preview_created"),
            ("Controlled Creation Approval Created", "controlled_creation_approval_handoff_created"),
            ("Controlled Creation Review Queue Item", "controlled_creation_review_queue_item_created"),
            ("Controlled Creation Action Created", "controlled_creation_action_created"),
            ("Controlled Creation Action Enqueued", "controlled_creation_action_enqueued"),
            ("Controlled Creation Action Executed", "controlled_creation_action_executed"),
            ("Folder Creation Request Created", "folder_creation_request_created"),
            ("Folder Creation Target Created", "folder_creation_target_created"),
            ("Folder Creation Preview Created", "folder_creation_preview_created"),
            ("Simple File Creation Request Created", "simple_file_creation_request_created"),
            ("Simple File Creation Target Created", "simple_file_creation_target_created"),
            ("Simple File Content Preview Created", "simple_file_creation_content_preview_created"),
            ("Parent Path Allowlist Resolved", "parent_path_allowlist_resolved"),
            ("Target Path Canonicalized", "target_path_canonicalized"),
            ("Target Path Existence Checked", "target_path_existence_checked"),
            ("Target Path Accessed", "target_path_accessed"),
            ("Directory Listing Performed", "directory_listing_performed"),
            ("File Read Performed", "file_read_performed"),
            ("File Content Preview Created", "file_content_preview_created"),
            ("Folder Created", "folder_created"),
            ("Project Folder Created", "project_folder_created"),
            ("Simple File Created", "simple_file_created"),
            ("Project Simple File Created", "project_simple_file_created"),
            ...
            ("Folder Mkdir Performed", "folder_mkdir_performed"),
            ("Filesystem Mutated", "filesystem_mutated"),
            ("Shell File Creation Dispatched", "shell_file_creation_dispatched"),
            ("OS File Creation Dispatched", "os_file_creation_dispatched"),
            ("Tool File Creation Dispatched", "tool_file_creation_dispatched"),
            ("Action Executed", "action_executed"),
            ("Command Executed", "command_executed"),
            ("Tool Executed", "tool_executed"),
            ("File Mutated", "file_mutated"),
            ...
            ("Audit Event Written", "audit_event_written"),
            ("No Controlled Creation Request", "no_controlled_creation_request_creation"),
            ("No Controlled Creation Target Resolution", "no_controlled_creation_target_resolution"),
            ("No Controlled Creation Preview", "no_controlled_creation_preview_creation"),
            ("No Controlled Creation Preview Render", "no_controlled_creation_preview_render"),
            ("No Controlled Creation Approval", "no_controlled_creation_approval_handoff"),
            ("No Controlled Creation Review Queue", "no_controlled_creation_review_queue_enqueue"),
            ("No Controlled Creation Dispatch", "no_controlled_creation_dispatch"),
            ("No Folder Creation Runtime", "no_folder_creation_runtime"),
            ("No Simple File Creation Runtime", "no_simple_file_creation_runtime"),
            ("No Project Folder Creation Runtime", "no_project_folder_creation_runtime"),
            ("No Project Simple File Creation Runtime", "no_project_simple_file_creation_runtime"),
            ("No Parent Path Allowlist Resolution", "no_parent_path_allowlist_resolution"),
            ("No Target Path Canonicalization", "no_target_path_canonicalization"),
            ("No Target Path Access", "no_target_path_access"),
            ("No Directory Listing", "no_directory_listing"),
            ...
            ("No Folder Mkdir", "no_folder_mkdir"),
            ("No Filesystem Mutation", "no_filesystem_mutation"),
            ("No Shell File Creation Dispatch", "no_shell_file_creation_dispatch"),
            ("No OS File Creation Dispatch", "no_os_file_creation_dispatch"),
            ("No Tool File Creation Dispatch", "no_tool_file_creation_dispatch"),
            ("No Create Without Preview", "no_create_without_preview"),
            ("No Create Without Approval", "no_create_without_explicit_approval"),
            ("No Create Without Permission", "no_create_without_permission"),
            ("No Create Without Audit Correlation", "no_create_without_audit_correlation"),
            ("No Create Non-Allowlisted Path", "no_create_non_allowlisted_path"),
            ("No Create Arbitrary Path", "no_create_arbitrary_path"),
            ("No Create Hidden Path", "no_create_hidden_path"),
            ("No Create System Path", "no_create_system_path"),
            ("No Create Credential Path", "no_create_credential_path"),
            ("No Create Executable File", "no_create_executable_file"),
            ("No Create Binary File", "no_create_binary_file"),
            ("No Overwrite Existing Path", "no_overwrite_existing_path"),
            ("No Delete Or Replace Path", "no_delete_or_replace_path"),
            ("No Recursive Bulk Creation", "no_recursive_bulk_creation"),
            ("No Multi-Step Creation Chain", "no_multi_step_creation_chain"),
            ("No Network Path Creation", "no_network_path_creation"),
            ("No File Mutation", "no_file_mutation"),
            ("No Desktop Action", "no_desktop_action"),
            ("No Application Launch", "no_application_launch"),
            ("Safety Blocker Count", "safety_blocker_count"),
