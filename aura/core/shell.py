...
class AuraShell:
    ...
    def active_permission_runtime_alpha_status(self) -> None:
        ...
        print("AURA Control Center Approval Workflow Alpha")
        print("===========================================")

        def row(label: str, key: str, fallback: object = "n/a") -> None:
            print(f"{label:<44}: {status.get(key, fallback)}")
        ...
        rows = [
            ...
            ("S218 Approval Ready", "sprint_218_control_center_approval_workflow_contract_ready"),
            ("S218 Approval Runtime", "control_center_approval_workflow_runtime_ready"),
            ("S218 Approval Status", "control_center_approval_workflow_status"),
            ...
            ("Preview Before Approval", "preview_before_approval_required"),
            ("Explicit User Decision", "explicit_user_decision_required"),
            ("Approve Or Deny Required", "approve_or_deny_required"),
            ("Permission Scope Required", "permission_scope_before_approval_required"),
            ("Audit Correlation Required", "audit_correlation_before_approval_required"),
            ("Review Queue Item Required", "review_queue_item_before_approval_required"),
            ("Control Center Visibility Required", "control_center_visibility_before_decision_required"),
            ("Approval Request Schema", "control_center_approval_request_schema_ready"),
            ("Approval Preview Schema", "control_center_approval_preview_schema_ready"),
            ("Approval Decision Schema", "control_center_approval_decision_schema_ready"),
            ("Approval Review Queue Schema", "control_center_approval_review_queue_schema_ready"),
            ("Allowed Approval Profiles", "allowed_control_center_approval_profile_count"),
            ("Blocked Approval Targets", "blocked_control_center_approval_target_count"),
            ("Approval Request Creation", "control_center_approval_request_creation_allowed"),
            ("Approval Preview Render", "control_center_approval_preview_render_allowed"),
            ("Approval Decision Creation", "control_center_approval_decision_creation_allowed"),
            ("Approval Decision Apply", "control_center_approval_decision_apply_allowed"),
            ("Approval Grant Creation", "control_center_approval_grant_creation_allowed"),
            ("Approval Denial Creation", "control_center_approval_denial_creation_allowed"),
            ("Approval Queue Mutation", "control_center_approval_review_queue_mutation_allowed"),
            ("Permission Mutation Allowed", "permission_state_mutation_allowed"),
            ("Grant Packet Creation", "grant_packet_creation_allowed"),
            ("Audit Write Allowed", "audit_write_allowed"),
            ("Action Dispatch Allowed", "action_execution_dispatch_allowed"),
            ("Approval Request Created", "control_center_approval_request_created"),
            ("Approval Preview Rendered", "control_center_approval_preview_rendered"),
            ("Approval Decision Created", "control_center_approval_decision_packet_created"),
            ("Approval Decision Applied", "control_center_approval_decision_applied"),
            ("Approval Grant Created", "control_center_approval_grant_created"),
            ("Approval Denial Created", "control_center_approval_denial_created"),
            ("Approval Queue Mutated", "control_center_approval_review_queue_mutated"),
            ...
            ("No Approval Request", "no_control_center_approval_request_creation"),
            ("No Approval Preview Render", "no_control_center_approval_preview_render"),
            ("No Approval Decision Apply", "no_control_center_approval_decision_apply"),
            ("No Approval Grant Creation", "no_control_center_approval_grant_creation"),
            ("No Approval Queue Mutation", "no_control_center_approval_review_queue_mutation"),
            ("No Approve Without Preview", "no_approve_without_preview"),
            ("No Approve Without Explicit User", "no_approve_without_explicit_user"),
            ("No Permission Mutation From Approval", "no_permission_state_mutation_from_approval"),
            ("No Action Dispatch From Approval", "no_action_dispatch_from_approval"),
            ("No Autonomous Approval Decision", "no_autonomous_approval_decision"),
    ...
    def active_permission_runtime_status(self) -> None:
        ...
        print("AURA Control Center Approval Workflow Status")
        print("============================================")
        ...
        rows = [
            ...
            ("Planning Ready", "planning_ready"),
            ("Runtime Ready", "runtime_ready"),
            ("Contract Ready", "control_center_approval_workflow_contract_ready"),
            ("S218 Approval Runtime", "control_center_approval_workflow_runtime_ready"),
            ("Runtime Status", "control_center_approval_workflow_status"),
            ("Current Sprint", "permission_action_current_sprint"),
            ("Next Sprint", "permission_action_next_sprint"),
            ("Next Boundary", "permission_action_next_boundary"),
            ("Preview Before Approval", "preview_before_approval_required"),
            ...
            ("Control Center Visibility Required", "control_center_visibility_before_decision_required"),
            ("Approval Request Schema", "control_center_approval_request_schema_ready"),
            ("Approval Context Schema", "control_center_approval_context_schema_ready"),
            ("Approval Preview Schema", "control_center_approval_preview_schema_ready"),
            ("Approval Decision Schema", "control_center_approval_decision_schema_ready"),
            ("Grant Candidate Schema", "control_center_approval_grant_candidate_schema_ready"),
            ("Denial Schema", "control_center_approval_denial_schema_ready"),
            ("Expiry Schema", "control_center_approval_expiry_schema_ready"),
            ("Approval Review Queue Schema", "control_center_approval_review_queue_schema_ready"),
            ("Approval Route Schema", "control_center_approval_route_schema_ready"),
            ("Allowed Approval Profiles", "allowed_control_center_approval_profile_count"),
            ("Blocked Approval Targets", "blocked_control_center_approval_target_count"),
            ("Approval Request Creation", "control_center_approval_request_creation_allowed"),
            ("Approval Preview Render", "control_center_approval_preview_render_allowed"),
            ...
            ("Approval Denial Creation", "control_center_approval_denial_creation_allowed"),
            ("Approval Queue Mutation", "control_center_approval_review_queue_mutation_allowed"),
            ("Approval Surface Runtime", "control_center_approval_surface_runtime_ready"),
            ("Approval Route Mutation", "control_center_approval_route_mutation_allowed"),
            ("Dashboard Approval Event Emit", "dashboard_approval_event_emit_allowed"),
            ("Control Center Mutating Endpoint", "control_center_mutating_endpoint_allowed"),
            ("Permission Mutation Allowed", "permission_state_mutation_allowed"),
            ("Grant Packet Creation", "grant_packet_creation_allowed"),
            ("Grant Persistence", "grant_persistence_allowed"),
            ("Audit Write Allowed", "audit_write_allowed"),
            ("Action Dispatch Allowed", "action_execution_dispatch_allowed"),
            ...
            ("Approval Denial Created", "control_center_approval_denial_created"),
            ("Approval Queue Mutated", "control_center_approval_review_queue_mutated"),
            ("Approval Permission Mutated", "approval_permission_state_mutated"),
            ("Approval Action Dispatched", "approval_action_dispatched"),
            ("Permission State Mutated", "permission_state_mutated"),
            ("Permission Grant Created", "permission_grant_created"),
            ("Audit Event Written", "audit_event_written"),
            ("Action Executed", "action_executed"),
            ...
            ("No Approve Without Preview", "no_approve_without_preview"),
            ("No Approve Without Explicit User", "no_approve_without_explicit_user"),
            ("No Approve Without Permission Scope", "no_approve_without_permission_scope"),
            ("No Approve Without Audit Correlation", "no_approve_without_audit_correlation"),
            ("No Approve Without Review Queue", "no_approve_without_review_queue_item"),
            ("No Permission Mutation From Approval", "no_permission_state_mutation_from_approval"),
            ("No Action Dispatch From Approval", "no_action_dispatch_from_approval"),
            ("No File Creation From Approval", "no_file_creation_from_approval"),
            ("No App Launch From Approval", "no_application_launch_from_approval"),
            ("No Autonomous Approval Decision", "no_autonomous_approval_decision"),
            ("Safety Blocker Count", "safety_blocker_count"),
            ("All Safety Blockers Off", "all_safety_blockers_inactive"),
            ("Runtime Scope", "runtime_scope"),
    ...
    def active_permission_runtime_check(self) -> None:
        ...
        planner = ActivePermissionRuntimePlanner()
        check = planner.check()
        contract = check.get("control_center_approval_workflow_contract", {})

        print("AURA Control Center Approval Workflow Check")
        print("===========================================")
        ...
        print()
        print("Sprint 218 Control Center Approval Workflow")
        print("-------------------------------------------")

        def row(label: str, key: str) -> None:
            print(f"{label:<48}: {contract.get(key)}")

        sprint_rows = [
            ("Contract Ready", "control_center_approval_workflow_contract_ready"),
            ("Runtime Ready", "control_center_approval_workflow_runtime_ready"),
            ("Runtime Status", "control_center_approval_workflow_status"),
            ("S218 Approval Ready", "control_center_approval_workflow_contract_ready"),
            ("S218 Approval Runtime", "control_center_approval_workflow_runtime_ready"),
            ("Current Sprint", "permission_action_current_sprint"),
            ("Next Sprint", "permission_action_next_sprint"),
            ("Next Boundary", "permission_action_next_boundary"),
            ...
            ("Preview Before Approval Required", "preview_before_approval_required"),
            ("Explicit User Decision Required", "explicit_user_decision_required"),
            ("Approve Or Deny Required", "approve_or_deny_required"),
            ("Permission Scope Before Approval", "permission_scope_before_approval_required"),
            ("Audit Correlation Before Approval", "audit_correlation_before_approval_required"),
            ("Review Queue Before Approval", "review_queue_item_before_approval_required"),
            ("Control Center Visibility Required", "control_center_visibility_before_decision_required"),
            ("Single Approval Decision Required", "single_approval_decision_required"),
            ("Approval Expiry Required", "approval_expiry_required"),
            ...
            ("Denial Schema", "control_center_approval_denial_schema_ready"),
            ("Expiry Schema", "control_center_approval_expiry_schema_ready"),
            ("Audit Correlation Schema", "control_center_approval_audit_correlation_schema_ready"),
            ("User Visible Summary Schema", "control_center_approval_user_visible_summary_schema_ready"),
            ("Review Queue Schema", "control_center_approval_review_queue_schema_ready"),
            ("Route Schema", "control_center_approval_route_schema_ready"),
            ("Safety Matrix Schema", "control_center_approval_safety_matrix_schema_ready"),
            ("Allowed Approval Profile Count", "allowed_control_center_approval_profile_count"),
            ("Blocked Approval Target Count", "blocked_control_center_approval_target_count"),
            ("Approval Request Creation", "control_center_approval_request_creation_allowed"),
            ("Approval Context Resolution", "control_center_approval_context_resolution_allowed"),
            ("Approval Preview Render", "control_center_approval_preview_render_allowed"),
            ("Approval Decision Creation", "control_center_approval_decision_creation_allowed"),
            ("Approval Decision Apply", "control_center_approval_decision_apply_allowed"),
            ("Approval Grant Creation", "control_center_approval_grant_creation_allowed"),
        ...
        safety_rows = [
            ("Approval Request Created", "control_center_approval_request_created"),
            ("Approval Context Created", "control_center_approval_context_packet_created"),
            ("Approval Preview Rendered", "control_center_approval_preview_rendered"),
            ("Approval Decision Created", "control_center_approval_decision_packet_created"),
            ("Approval Decision Applied", "control_center_approval_decision_applied"),
            ("Approval Grant Candidate Created", "control_center_approval_grant_candidate_created"),
            ("Approval Grant Created", "control_center_approval_grant_created"),
            ("Approval Denial Created", "control_center_approval_denial_created"),
            ("Approval Queue Item Created", "control_center_approval_review_queue_item_created"),
            ("Approval Queue Mutated", "control_center_approval_review_queue_mutated"),
            ("Approval Surface Rendered", "control_center_approval_surface_rendered"),
            ("Dashboard Approval Event Emitted", "dashboard_approval_event_emitted"),
            ("Control Center Mutating Endpoint Called", "control_center_mutating_endpoint_called"),
            ("Approval Permission Mutated", "approval_permission_state_mutated"),
            ("Approval Action Dispatched", "approval_action_dispatched"),
            ("Approval File Creation Dispatched", "approval_file_creation_dispatched"),
            ("Approval App Launch Dispatched", "approval_application_launch_dispatched"),
            ("Autonomous Approval Decision", "autonomous_approval_decision_made"),
            ("Permission State Mutated", "permission_state_mutated"),
            ("Permission Grant Created", "permission_grant_created"),
            ("Audit Event Written", "audit_event_written"),
            ("Action Executed", "action_executed"),
            ...
            ("No Approval Request", "no_control_center_approval_request_creation"),
            ("No Approval Preview Render", "no_control_center_approval_preview_render"),
            ("No Approval Decision Creation", "no_control_center_approval_decision_creation"),
            ("No Approval Decision Apply", "no_control_center_approval_decision_apply"),
            ("No Approval Grant Creation", "no_control_center_approval_grant_creation"),
            ("No Approval Queue Mutation", "no_control_center_approval_review_queue_mutation"),
            ("No Dashboard Approval Event Emit", "no_dashboard_approval_event_emit"),
            ("No Control Center Mutating Endpoint", "no_control_center_mutating_endpoint"),
            ("No Approve Without Preview", "no_approve_without_preview"),
            ("No Approve Without Explicit User", "no_approve_without_explicit_user"),
            ("No Approve Without Permission Scope", "no_approve_without_permission_scope"),
            ("No Approve Without Audit Correlation", "no_approve_without_audit_correlation"),
            ("No Approve Without Review Queue", "no_approve_without_review_queue_item"),
            ("No Approve Privileged Action", "no_approve_privileged_action"),
            ("No Approve Delete File", "no_approve_delete_file"),
            ("No Approve Network Upload", "no_approve_network_upload"),
            ("No Approve Dependency Install", "no_approve_dependency_install"),
            ("No Approve Multi-Step Automation", "no_approve_multi_step_automation"),
            ("No Denial Without Reason", "no_denial_without_reason"),
            ("No Permission Mutation From Approval", "no_permission_state_mutation_from_approval"),
            ("No Action Dispatch From Approval", "no_action_dispatch_from_approval"),
            ("No File Creation From Approval", "no_file_creation_from_approval"),
            ("No Application Launch From Approval", "no_application_launch_from_approval"),
            ("No Autonomous Approval Decision", "no_autonomous_approval_decision"),
            ("Safety Blocker Count", "safety_blocker_count"),
            ("All Safety Blockers Off", "all_safety_blockers_inactive"),
        ]
        ...
        print()
        print("Control Center Approval Workflow Safety State")
        print("---------------------------------------------")
