...
Current version: v0.154.0-genesis  
...
AURA has completed Sprint 154.0 and is now inside the Sprint 151-160 Control Center Runtime block.
...
- online capabilities: 83
- foundation-only capabilities: 67
...
- Sprint 154: Control Center Plugin Panel Foundation completed
...
- Current completed sprint: Sprint 154.0 — Control Center Plugin Panel Foundation
- Next planned sprint: Sprint 155.0 — Control Center Service Monitor Panel Foundation
...
At v0.154.0-genesis, AURA cannot yet:
