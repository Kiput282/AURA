...
Current version: v0.157.0-genesis  
...
AURA has completed Sprint 157.0 and is now inside the Sprint 151-160 Control Center Runtime block.
...
- online capabilities: 86
- foundation-only capabilities: 70
...
- Sprint 157: Control Center Service Monitor Panel Foundation completed
...
- Version: v0.157.0-genesis
- Current completed sprint: Sprint 157.0 — Control Center Service Monitor Panel Foundation
- Next planned sprint: Sprint 158.0 — Control Center Configuration and Port Registry Viewer Foundation
...
At v0.157.0-genesis, AURA cannot yet:
