...
Current version: v0.153.0-genesis  
...
AURA has completed Sprint 153.0 and is now inside the Sprint 151-160 Control Center Runtime block.
...
- online capabilities: 82
- foundation-only capabilities: 66
...
- Sprint 153: Control Center Capability Viewer Foundation completed
...
- Current completed sprint: Sprint 153.0 — Control Center Capability Viewer Foundation
- Next planned sprint: Sprint 154.0 — Control Center Service Monitor Panel Foundation
...
At v0.153.0-genesis, AURA cannot yet:
