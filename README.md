...
Current version: v0.158.0-genesis  
...
AURA has completed Sprint 158.0 and is now inside the Sprint 151-160 Control Center Runtime block.
...
- online capabilities: 87
- foundation-only capabilities: 71
...
- Sprint 158: Control Center Action Log Panel Foundation completed
...
- Version: v0.158.0-genesis
- Current completed sprint: Sprint 158.0 — Control Center Action Log Panel Foundation
- Next planned sprint: Sprint 159.0 — Control Center Configuration and Port Registry Viewer Foundation
...
At v0.158.0-genesis, AURA cannot yet:
